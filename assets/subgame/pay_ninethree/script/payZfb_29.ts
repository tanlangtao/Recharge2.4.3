...
export default class NewClass extends cc.Component {
    ...
    init(data){
        ...
        if(this.channel == 'alipay' ){
            ...
            if(p_id == 8 || p_id == 10 || p_id == 15|| p_id == 9 ||p_id ==12||p_id ==16 ||p_id ==18 ||p_id ==20 ||p_id ==22 || p_id ==29){
    ...
    public initRender(index){
        ...
        if(this.current.name == this.handling_feeName && this.handling_fee !=0 ){
            ...
            }else if(this.app.UrlData.package_id == 29){
    ...
    public onClick(){
        ...
        if(this.amountLabel.string ==Language_pay.Lg.ChangeByText('点击输入')){
            ...
            else if(this.app.UrlData.package_id == 29 && this.current.name == this.handling_feeName && this.handling_fee !=0){
                //小额渠道提示
    ...
    showPayIM(){
        var url = `${this.app.UrlData.host}/api/payment/payment?user_id=${this.app.UrlData.user_id}&user_name=${decodeURI(this.app.UrlData.user_name)}&payment_amount=${this.amountLabel.string}&channel_type=${this.current.channel_id}&channel_name=${this.current.name}&pay_name=${this.current.nick_name}&pay_type=${this.current.pay_type}&client=${this.app.UrlData.client}&proxy_user_id=${this.app.UrlData.proxy_user_id}&proxy_name=${decodeURI(this.app.UrlData.proxy_name)}&package_id=${this.app.UrlData.package_id}&order_ip=${this.login_ip ? this.login_ip:"127.0.0.1"}&device_id=${this.app.gHandler.app.deviceID}&token=${this.app.token}&center_auth=${this.app.login_token}`;
        cc.find('payGlobal').getComponent('payGlobal_29').imWebViewUrl = encodeURI(url)
            ...
            if(show){
                if(this.results[i].rate != "" && this.results[i].rate !="0.0000"){
                    ...
                    if(packageArr.indexOf(this.app.UrlData.package_id)>-1){
                        ...
                        node.getComponent('paySelectItem_29').init({
    ...
    showBindBankAccountTip(){
        ...
        node.getComponent("payBindBankAccountTipAlert_29").init(this)
        //检测是否已存在弹窗，避免重复显示
    ...
    showAccountAlert_29(){
        ...
        this.node.getComponent("payBankAccountAlert_29").init({
            text:'设置银行卡',
            action:"add",
            itemId:null,
            parentComponent:this,
    ...
    setLanguageResource(){
        ...
        if(this.app.UrlData.package_id != 15 && this.app.UrlData.package_id != 20 && this.app.UrlData.package_id != 29 && this.app.UrlData.package_id != 18 && this.app.UrlData.package_id != 12 && this.app.UrlData.package_id != 22){
        ...
        }else if(this.app.UrlData.package_id == 15 || this.app.UrlData.package_id == 29 || this.app.UrlData.package_id == 18||this.app.UrlData.package_id == 20 ||this.app.UrlData.package_id == 12 ||this.app.UrlData.package_id == 22){
        }else{
            this.app.loadIconLg(`${src}/btn/75`,btn_75)
    ...
    blinkFun(blinkNode){
        if(this.app.UrlData.package_id == 18 || this.app.UrlData.package_id == 29){
            //18不闪烁
