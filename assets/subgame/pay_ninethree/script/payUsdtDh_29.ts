...
export default class NewClass extends cc.Component {
    ...
    showCashAlert(conf_val){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_29')
        ...
        node.getComponent('payCashAlert_29').init({
    ...
    onClick(){
        ...
        if(this.results.length==0){
            ...
            //渠道16需判断安全码
            if(this.app.UrlData.package_id == 29 && this.AqmLabel.string == "点击输入"){
    ...
    setLanguageResource(){
        ...
        if(this.app.UrlData.package_id == 8 || this.app.UrlData.package_id == 9){
            ...
            this.app.loadIconLg(`${src}/font/jiesuan`,btn.children[0])
        }else if(this.app.UrlData.package_id == 15||this.app.UrlData.package_id == 20 || this.app.UrlData.package_id == 18  || this.app.UrlData.package_id == 29|| this.app.UrlData.package_id == 12 || this.app.UrlData.package_id == 22){
