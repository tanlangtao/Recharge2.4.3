...
var commonVal = require("proxy-http");
cc.Class({
    ...
    confirm() {
        ...
        if (this.CofAmount.string.indexOf(".") > -1) {
            ...
            if (gHandler.app.pinpai == 'huaxing') {
                ...
                if (411 <= parseInt(Database.page9_gz_plaumont) && parseInt(Database.page9_gz_plaumont) <= 450 &&   this.nums==1) {

                    cc.log('设置失败 411 - 450', mon);
                    this.CofAmount.string = ''
            ...
            } else if (gHandler.app.pinpai == 'huangshi' && 281 <= parseInt(Database.page9_gz_plaumont) && parseInt(Database.page9_gz_plaumont) <= 320) {
                cc.log(
                    'Database.page9_gz_plaumont==', Database.page9_gz_plaumont,
                    'mon====', mon,
                    'Database.base_dividend_control==', Database.base_dividend_control, '剪完', parseInt(Database.page9_gz_plaumont) - parseInt(mon));
            ...
            }else if (gHandler.app.pinpai == 'huaxing' && 170 <= parseInt(Database.page9_gz_plaumont) && parseInt(Database.page9_gz_plaumont) <= 410 && this.nums == 1) {
