...
cc.Class({
    ...
    onLoad() {
        ...
        cc.log('gHandler.gameGlobal.token====', gHandler.gameGlobal.token)
        //获取显示专属链接
        ...
        if (gHandler.app.pinpai == 'debi' || gHandler.app.pinpai == 'xinsheng' || gHandler.app.pinpai == 'fuxin' || gHandler.app.pinpai == 'yuyu' || gHandler.app.pinpai == 'xingui' || gHandler.app.pinpai == 'xinhao' || gHandler.app.pinpai == 'xinlong' || gHandler.app.pinpai == 'nineone' || gHandler.app.pinpai == 'huangshi' || gHandler.app.pinpai == 'juding'|| gHandler.app.pinpai == 'huaxing') {
            if (gHandler.app.pinpai == 'fuxin' || gHandler.app.pinpai == 'yuyu' || gHandler.app.pinpai == 'juding' || gHandler.app.pinpai == 'huaxing') {
            ...
            xhr.onreadystatechange = () => {
                if (xhr.readyState == 4 && xhr.status === 200) {
                    ...
                    if (resData.code === 200) {
                        ...
                        if (gHandler.app.pinpai == 'fuxin' || gHandler.app.pinpai == 'juding'|| gHandler.app.pinpai == 'huaxing') {
                            function a() {
                        ...
                        // 请求团队总人数数据 测试时屏蔽
                        let urls
                        urls = hqq.app.server + `/proxy/proxy/GetProxyUserNumber?platform_key=123456&account_name=${account_name}&ids=[${account_name}]`
                        cc.log(urls);
        ...
        // 671627403  91顶级号
        // 649506476  聚鼎顶级号
        // var sendData = `account_name=${608265820}&password=123456`;
        //正式
        ...
        if (gHandler.app.pinpai != 'xingui' || gHandler.app.pinpai != 'xinsheng' || gHandler.app.pinpai != 'xinhao' || gHandler.app.pinpai == 'xinlong' || gHandler.app.pinpai == 'nineone'  || gHandler.app.pinpai == 'huaxing') {
            var clickEventHandler = new cc.Component.EventHandler();
