...
cc.Class({
    ...
    setMyItemData() {
        ...
        cc.log('p6     data===', data.statement_cost_money);
        if (data != undefined && data != null) {
            ...
            console.log('流水分红扣除', parseFloat(data.top_up), Math.abs(parseFloat(data.withdraw)), parseFloat(data.first_balance), parseFloat(data.last_balance), parseFloat(data.amount), liushui);
    ...
    setItemData(data, i) {
        ...
        console.log('流水分红扣除1', parseFloat(data.top_up), Math.abs(parseFloat(data.withdraw)), parseFloat(data.first_balance), parseFloat(data.last_balance), parseFloat(data.amount), liushui);
    ...
    checkClick(event, args) {
        ...
        console.log('被选中列表', this.checkedItemIndex);
    },
    OPenCalendar() { //打开日历
        //音效
        Database.clickSound(Database.hall_sound)
