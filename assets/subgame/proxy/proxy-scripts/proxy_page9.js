...
cc.Class({
    ...
    checkMyAgent(event, num) {
        ...
        check().then(
            (value) => {
                ...
                this.minPage = 1; //最小页码
                this.maxPage = Math.ceil(Database.zsxjwjzs / 8); //Database.zsxjwjzs 是玩家总数最大页码
    ...
    page9setPageData() {
        ...
        let endIndex = this.currentPage * 8;
    ...
    page9setItemData(data) {
        ...
        if (gHandler.app.pinpai == 'juding') {
            btn3.on("touchend", () => {
                console.log('juding55555=', data.id);
                //音效
        ...
        if (gHandler.app.pinpai == "fuxin" || gHandler.app.pinpai == "nineone" || gHandler.app.pinpai == "xingui" || gHandler.app.pinpai == "debi" || gHandler.app.pinpai == "xinhao" || gHandler.app.pinpai == "xinlong") {
            console.log('Database.page9_plaumont==', Database.page9_plaumont);
    ...
    pageUporDown(event, flag) {
        ...
        if (this.btn) {
            ...
            if (Math.ceil(this.currentPage / 3) != this.datapage) {
                this.datapage = Math.ceil(this.currentPage / 3)
                cc.log(this.datapage);
                let num = this.datapage
                Database.page9_wjmx = [];
                ...
                check().then(
                    (value) => {
                        ...
                        this.data = Database.page9_wjmx;
                        cc.log('翻页后数据', Database.page9_wjmx);
                        Database.page9_ids = [];
                        ;
            ...
            check().then(
                (value) => {
                    ...
                    Promise.all([promise1]).then((values) => {
                        // this.page9setPageData()
                        // this.page9setPageIndex();
                        console.log('Database.page9_wjmx[1]===', Database.page9_wjmx[1]);
                        console.log(' Database.p9_dlsj===', Database.p9_dlsj);
