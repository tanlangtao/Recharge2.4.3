...
export default class NewClass extends cc.Component {
    ...
    deleteAmount(){
        ...
        node.getComponent("payJisuCyjeAlert_9").init(this.amountLabel,this.channel,this.setDepostLabel.bind(this))
    ...
    showCashAlert(){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_9')
        ...
        node.getComponent('payCashAlert_9').init({
