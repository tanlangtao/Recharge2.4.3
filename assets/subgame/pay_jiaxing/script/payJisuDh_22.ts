...
export default class NewClass extends cc.Component {
    ...
    deleteAmount(){
        ...
        node.getComponent("payJisuCyjeAlert_22").init(this.amountLabel,this.channel,this.setDepostLabel.bind(this))
    ...
    showCashAlert(){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_22')
        ...
        node.getComponent('payCashAlert_22').init({
