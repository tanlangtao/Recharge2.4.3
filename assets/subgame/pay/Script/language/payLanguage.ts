...
export namespace Language_pay {
    class Class_Language_pay {
        ...
        private Chinese =[
            ...
            "特别提醒:",
            "1. 只支持银行卡转银行卡支付；",
            "2. 支付时输入金额与订单金额一致，并填写附言(备注)信息；",
            "3. 正常付款1-5分钟内到账，未到账请联系客服。",
            "禁止修改金额，否则不到账；",
            ...
            "【温馨提示】",
            "       系统收款账号不定期更换，请勿保存！请每次付款前认真核对，打入非指定银行账号，损失自重！",
        ...
        getLgSrc(){
            let src = ''
            // gHandler.gameGlobal.pay.package_id = 8
            switch(this.Language){
                case "Chinese": 
