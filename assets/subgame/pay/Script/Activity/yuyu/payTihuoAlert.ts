...
export default class NewClass extends cc.Component {
    ...
    submitAddress(){
        ...
        let dataStr  = `user_id=${this.app.UrlData.user_id}&activity_id=${this.activity_id}&shipping_user=${shipping_user}&mobile=${mobile}&address=${address}&fruit_level=${this.fruit_level}&source_type=${this.source_type}&fruit_jin=${this.fruit_jin}&package_id=${this.app.UrlData.package_id}&login_ip=$${this.login_ip ? this.login_ip:"127.0.0.1"}&regin_ip=${this.app.gHandler.gameGlobal.regin_ip}&device_id=${this.app.gHandler.app.deviceID}`
        let self = this;
