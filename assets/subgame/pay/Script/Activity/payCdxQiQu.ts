...
export default class NewClass extends cc.Component {
    ...
    receiveHandleHeNeiWin(){
        ...
        let self = this;
        let dataStr = `user_id=${this.app.UrlData.user_id}&flag=2&package_id=${this.app.UrlData.package_id}&activity_id=${this.activity_id}&login_ip=${this.login_ip ? this.login_ip:"127.0.0.1"}&regin_ip=${this.app.gHandler.gameGlobal.regin_ip}&device_id=${this.app.gHandler.app.deviceID}`
