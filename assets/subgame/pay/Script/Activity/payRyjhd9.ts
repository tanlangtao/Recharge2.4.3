...
export default class NewClass extends cc.Component {
    ...
    receivePerformanceGold(){
        ...
        let self = this;
        let dataStr = `user_id=${this.app.UrlData.user_id}&index=${this.targeIndex}&source=1&package_id=${this.app.UrlData.package_id}&activity_id=${this.activity_id}&login_ip=${this.login_ip ? this.login_ip:this.app.gHandler.gameGlobal.regin_ip}&regin_ip=${this.app.gHandler.gameGlobal.regin_ip}&device_id=${this.app.gHandler.app.deviceID}`
