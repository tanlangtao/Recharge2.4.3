...
export default class NewClass extends cc.Component {
    ...
    receiveFristPayGold(){
        ...
        let self = this;
        let dataStr = `user_id=${this.app.UrlData.user_id}&activity_id=${this.activity_id}&login_ip=${this.login_ip ? this.login_ip:this.app.gHandler.gameGlobal.regin_ip}&regin_ip=${this.app.gHandler.gameGlobal.regin_ip}&device_id=${this.app.gHandler.app.deviceID}&package_id=${this.app.UrlData.package_id}`
