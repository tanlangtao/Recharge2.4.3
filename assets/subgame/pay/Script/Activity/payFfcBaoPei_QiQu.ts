...
export default class NewClass extends cc.Component {
    ...
    infoInit(){
        ...
        let group2 = cc.find("Canvas/Activity/Content/FfcBaoPei_QiQu/bg/Layout/group2")
    ...
    receiveRewardHeNei(){
        ...
        let self = this;
        let dataStr = `user_id=${this.app.UrlData.user_id}&user_name=${this.app.UrlData.user_name}&package_id=${this.app.UrlData.package_id}&activity_id=${this.activity_id}&lottery=PTXFFC&login_ip=${this.login_ip ? this.login_ip:this.app.gHandler.gameGlobal.regin_ip}&regin_ip=${this.app.gHandler.gameGlobal.regin_ip}&device_id=${this.app.gHandler.app.deviceID}`
    ...
    setLocal(){
        cc.sys.localStorage.setItem(`ApplyFfcBaoPei_QiQu_${this.app.UrlData.user_id}`,JSON.stringify(true))
    }
    //设置语言相关的资源和字
    setLanguageResource(){
