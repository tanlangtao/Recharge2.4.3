...
export default class NewClass extends cc.Component {
    ...
    deleteAmount(){
        ...
        node.getComponent("payJisuCyjeAlert_15").init(this.amountLabel,this.channel,this.setDepostLabel.bind(this))
    ...
    showCashAlert(){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_15')
        ...
        node.getComponent('payCashAlert_15').init({
