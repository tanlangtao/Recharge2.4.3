...
cc.Class({
    ...
    UILoad() {
        ...
        hqq.imgLoad(hdcxsj, "hall/language/" + hqq.language + "/img/hdcxsj")
        let hdffsj = cc.find("hbylayer/hdffsj")
        hqq.imgLoad(hdffsj, "hall/language/" + hqq.language + "/img/hdffsj")
        let hdyzje = cc.find("hbylayer/hdyzje")
        hqq.imgLoad(hdyzje, "hall/language/" + hqq.language + "/img/hdyzje")
        let tjhby = cc.find("hbylayer/tjhby")
        hqq.imgLoad(tjhby, "hall/language/" + hqq.language + "/img/tjhby")
        let zi = cc.find("hbylayer/zi")
        hqq.imgLoad(zi, "hall/language/" + hqq.language + "/img/zi")
