...
cc.Class({
    ...
    start() {
        ...
        if (hqq.app.needShowFree) {
            ...
            if (hqq.gameGlobal.player.phonenum == "") {
                ...
                //     return
                // }
                if(hqq.app.pinpai != "nineone" && hqq.app.pinpai != "huangshi" && hqq.app.pinpai != "huaxing" && hqq.app.pinpai != "ninetwo"){
    ...
    UILoad() {
        ...
        hqq.setSprite(this.topbubble, { path: "hall/language/" + hqq.language + "/img/topbubble", active: false })
        if (hqq.app.pinpai == "fuxin" ) {
            let hlpath = "hall/language/" + hqq.language + "/fuxin/"
            let hpath = "hall/fuxin/img/"
            background.getChildByName("fuxin").active = true
            hqq.setSprite(this.btngonggaopoint, { path: "hall/test/img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.jchdRedPoint, { path: "hall/test/img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.shouyipoint, { path: "hall/test/img/redpoint", position: { x: 0, y: 20 }, active: false })
            hqq.setSprite(this.kefupoint, { path: "hall/test/img/redpoint", position: { x: -5, y: 20 }, active: false })
            hqq.setSprite(background, { path: "hall/fuxin/bg" })
            ...
            hqq.setBtn(touxiang, { path: hpath + "touxiangkuang", size: { height: 90, width: 90 }, widget: { top: 20, left: 20 }, callback: "onClickPlayerBtn", script: this })
            hqq.setSprite(namebg, { path: hpath + "di2", widget: { left: 180, top: 30 }, size: { height: 40, width: 200 } })
            hqq.setSprite(goldback, { path: hpath + "di2", widget: { horizontalCenter: 0, top: 18 }, size: { width: 300 } })
            hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 190, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "ziyuantubiao", widget: { horizontalCenter: -125 } })

            // hqq.setBtn(btncopy, { normal: hpath + "bi", widget: { horizontalCenter: 80 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: hpath + "plus", widget: { horizontalCenter: 120 }, callback: "onClickPlus", script: this })

            hqq.setBtn(btnqmdl, { normal: hlpath + "icon5", widget: { top: 28, right: 10 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(btnjchd, { normal: hlpath + "icon3", widget: { top: 28, right: 160 }, callback: "onClickJCHD", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "icon2", widget: { top: 28, right: 290 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "btn_dh", widget: { left: 80, bottom: 5 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "kefu", widget: { left: 320, bottom: 5 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "mianfeijinbi", widget: { left: 560, bottom: 5 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { normal: hpath + "anniu2", widget: { right: 25, bottom: 0 }, callback: "onClickCC", script: this })
            let xinfuback = background.getChildByName("fuxin")
            hqq.addNode(xinfuback, { path: hpath + "fengexian", widget: { left: 240, bottom: 10 } })
            hqq.addNode(xinfuback, { path: hpath + "fengexian", widget: { left: 480, bottom: 10 } })
            hqq.addNode(xinfuback, { path: hpath + "fengexian", widget: { left: 720, bottom: 10 } })

            hqq.addNode(btnchongzhi, { path: hpath + "shop", x: -90, y: 10 })
            hqq.addNode(btnchongzhi, { path: hlpath + "chongzhi", x: 25, y: 10 })
            ...
            hqq.setBtn(btn_all, { normal: hlpath + "qbyx1", pressed: hlpath + "qbyx2", custom: this.menuBtnInfoList[0], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            hqq.setBtn(btn_duizhan, { normal: hlpath + "qpdz1", pressed: hlpath + "qpdz2", custom: this.menuBtnInfoList[1], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
            hqq.setBtn(btn_touzhu, { normal: hlpath + "cjtz1", pressed: hlpath + "cjtz2", custom: this.menuBtnInfoList[2], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
            hqq.setBtn(btn_shixun, { normal: hlpath + "zrsx1", pressed: hlpath + "zrsx2", custom: this.menuBtnInfoList[3], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_zuqiu")
            hqq.setBtn(btn_zuqiu, { normal: hlpath + "cpzq1", pressed: hlpath + "cpzq2", custom: this.menuBtnInfoList[4], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_jieji = this.menuBtnListNode.getChildByName("btn_jieji")
            hqq.setBtn(btn_jieji, { normal: hlpath + "jjdw1", pressed: hlpath + "jjdw2", custom: this.menuBtnInfoList[5], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_remen = this.menuBtnListNode.getChildByName("btn_remen") // 热门
            hqq.setBtn(btn_remen, { normal: hlpath + "rm1", pressed: hlpath + "rm2", custom: this.menuBtnInfoList[6], callback: "onClickFuxinMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            ...
            scroll.x = 10
            hqq.setSprite(panel, { path: hpath + "xiaoxikuang", })
            hqq.setSprite(panel.getChildByName("sp_trumpet"), { path: hpath + "laba", x: -375 })

            hqq.addNode(this.node, { normal: "base/language/CN/img/vip_diamond", widget:{horizontalCenter:220,bottom:-10} ,callback:"toogleManyCai",script:this});
            
            this.noticepanel.active = true
        } else if (hqq.app.pinpai == "xingui") { // xingui
            let hlpath = "hall/language/" + hqq.language + "/xingui/"
            let hpath = "hall/xingui/"
            ...
            hqq.setSprite(this.jchdRedPoint, { path: hpath + "img/dian0", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.btngonggaopoint, { path: hpath + "img/dian0", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.shouyipoint, { path: hpath + "img/dian0", position: { x: 0, y: 20 }, active: false })
            hqq.setSprite(this.kefupoint, { path: hpath + "img/dian0", position: { x: -5, y: 20 }, active: false })
            hqq.setSprite(background, { path: hpath + "bg" })

            hqq.setLabel(this.namelabel, { string: "", widget: { left: -65 }, fontSize: 30 })
            hqq.setLabel(this.coinlabel, { string: "", fontSize: 35, widget: { horizontalCenter: -6 } })
            hqq.setBtn(touxiang, { path: hpath + "img/tx", widget: { top: 0, left: 5 }, callback: "onClickPlayerBtn", script: this })

            hqq.setSprite(namebg, { path: hpath + "img/zyd", widget: { left: 70, top: 23 }, size: { height: 40, width: 200 } })
            hqq.setSprite(goldback, { path: hpath + "img/d_jb", widget: { top: 18 ,left:(350 * (cc.winSize.width / 1334) )}, size: { width: 300, height: 70 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 180, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "img/icon_jb", widget: { horizontalCenter: -125 } })
            
            btncopy.active = false;
            // hqq.setBtn(btncopy, { normal: hpath + "img/btn_xg", widget: { horizontalCenter: 95 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: "hall/test/img/btn_refresh2", widget: { horizontalCenter: 100 }, callback: "onClickGetGold", script: this ,size: { height: 61, width: 61 }})

            hqq.setBtn(btnjchd, { normal: hlpath + "btn_jchd", widget: { top: 11, right: 270 }, callback: "onClickJCHD", script: this })
            hqq.setBtn(btnqmdl, { normal: hlpath + "btn_qmdl", widget: { top: 11, right: 150 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "btn_gg", widget: { top: 11, right: 25 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "btn_sy", widget: { left: 120, bottom: 5 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "btn_kf", widget: { left: 360, bottom: 5 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "btn_mfjb", widget: { left: 600, bottom: 5 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { normal: hlpath + "btn_cz", widget: { right: 25, bottom: 0 }, callback: "onClickCC", script: this })

            hqq.setWidget(subgameview, { left: 600, top: 100, bottom: 100 })

            hqq.addNode(this.node, { normal: "base/language/CN/img/vip_diamond", widget:{horizontalCenter:300,bottom:-10} ,callback:"toogleManyCai",script:this});
            
            this.noticepanel.active = true
        } else if (hqq.app.pinpai == "xinsheng") {
            let hlpath = "hall/language/" + hqq.language + "/xinsheng/img/"
            let hpath = "hall/xinsheng/"
            this.youkeicon.x = 20
            this.youkeicon.y = 20
            hqq.setSprite(this.jchdRedPoint, { path: hpath + "img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.btngonggaopoint, { path: hpath + "img/redpoint", position: { x: -80, y: 20 }, active: false })
            hqq.setSprite(this.shouyipoint, { path: hpath + "img/redpoint", position: { x: 0, y: 20 }, active: false })
            hqq.setSprite(this.kefupoint, { path: hpath + "img/redpoint", position: { x: -5, y: 20 }, active: false })
            hqq.setSprite(background, { path: hpath + "bigimg/hallback" })
            ...
            hqq.setBtn(touxiang, { path: hpath + "img/touxiang", widget: { top: 10, left: 5 }, callback: "onClickPlayerBtn", script: this })
            mask.getComponent(cc.Mask).spriteFrame = hqq.getSpriteFrame(hpath + "img/headmask")
            hqq.setSprite(namebg, { path: hpath + "img/frameback", widget: { left: 75, top: 20 } })
            hqq.setSprite(goldback, { path: hpath + "img/frameback", widget: { left: 270, top: 20 }, size: { width: 200 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 160, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: "hall/test/img/sp_coin2", widget: { horizontalCenter: -100 } })
            // hqq.setBtn(btncopy, { normal: hpath + "img/btncopy", widget: { horizontalCenter: 81 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: "hall/test/img/btn_refresh2", widget: { horizontalCenter: 95 }, callback: "onClickGetGold", script: this ,size: { height: 61, width: 61 } })

            // hqq.setBtn(this.btnhby, { normal: hlpath + "btnhby", widget: { top: 15, right: 460 }, callback: "onClickHBY", script: this })
            // hqq.setBtn(this.btnjfcj, { normal: hlpath + "btnjfcj", widget: { top: 15, right: 355 }, callback: "onClickJFCJ", script: this })
            hqq.setBtn(btnjchd, { normal: hlpath + "btnjchd", widget: { top: 15, right: 240 }, callback: "onClickJCHD", script: this })
            hqq.setBtn(btnqmdl, { normal: hlpath + "btnqmdl", widget: { top: 15, right: 115 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "btngg", widget: { left: 376, bottom: 0,closetop:true,closeright:true }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "btnshouyi", widget: { left: 0, bottom: 0 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "btnkefu", widget: { left: 188, bottom: 0 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "btnmfjb", widget: { left: 564, bottom: 0 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { normal: hlpath + "btnchongzhi", widget: { right: 0, bottom: 0 }, callback: "onClickCC", script: this })

            this.menuBtnListNode = cc.find("Canvas/hallback/xinsheng/xinshengmenu")
            let btn_all = this.menuBtnListNode.getChildByName("btn_all")
            hqq.setBtn(btn_all, { normal: hlpath + "btn_all", pressed: hlpath + "btn_all1", custom: this.menuBtnInfoList[0], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            let btn_changyong = this.menuBtnListNode.getChildByName("btn_changyong")
            hqq.setBtn(btn_changyong, { normal: hlpath + "btn_changyong", pressed: hlpath + "btn_changyong1", custom: this.menuBtnInfoList[1], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            hqq.setBtn(btn_duizhan, { normal: hlpath + "btn_duizhan", pressed: hlpath + "btn_duizhan1", custom: this.menuBtnInfoList[2], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
            hqq.setBtn(btn_touzhu, { normal: hlpath + "btn_touzhu", pressed: hlpath + "btn_touzhu1", custom: this.menuBtnInfoList[3], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
            hqq.setBtn(btn_shixun, { normal: hlpath + "btn_shixun", pressed: hlpath + "btn_shixun1", custom: this.menuBtnInfoList[4], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_zuqiu")
            hqq.setBtn(btn_zuqiu, { normal: hlpath + "btn_zuqiu", pressed: hlpath + "btn_zuqiu1", custom: this.menuBtnInfoList[5], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_jieji = this.menuBtnListNode.getChildByName("btn_jieji")
            hqq.setBtn(btn_jieji, { normal: hlpath + "btn_jieji", pressed: hlpath + "btn_jieji1", custom: this.menuBtnInfoList[6], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            
            hqq.addNode(this.node, { normal: "base/language/CN/img/vip_diamond", widget:{horizontalCenter:150,bottom:-10} ,callback:"toogleManyCai",script:this});
            this.xinshengad1 = hqq.addNode(cc.find("Canvas/hallback/xinsheng/xinshengmenu"),{skeleton:"hall/language/CN/xinsheng/AD1-yueru/",aniname:"animation",loop:true,widget:{left:-45}});
            this.xinshengad2 = hqq.addNode(cc.find("Canvas/hallback/xinsheng/xinshengmenu"),{skeleton:"hall/language/CN/xinsheng/AD2-share/",aniname:"animation",loop:true,widget:{left:-45}});
            ...
            this.youkeicon.y = 20
            hqq.setSprite(this.jchdRedPoint, { path: hpath + "img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.btngonggaopoint, { path: hpath + "img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.shouyipoint, { path: hpath + "img/redpoint", position: { x: 0, y: 20 }, active: false })
            hqq.setSprite(this.kefupoint, { path: hpath + "img/redpoint", position: { x: -5, y: 20 }, active: false })
            hqq.setSprite(background, { path: hpath + "bigimg/hallback" })
            background.getChildByName("xinsheng").active = true
            ...
            mask.getComponent(cc.Mask).spriteFrame = hqq.getSpriteFrame(hpath + "img/headmask")
            hqq.setSprite(namebg, { path: hpath + "img/frameback", widget: { left: 75, top: 20 } })
            hqq.setSprite(goldback, { path: hpath + "img/frameback", widget: { left: 320, top: 20 }, size: { width: 200 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 160, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: "hall/test/img/sp_coin2", widget: { horizontalCenter: -100 } })
            // hqq.setBtn(btncopy, { normal: hpath + "img/btncopy", widget: { horizontalCenter: 81 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: "hall/test/img/btn_refresh2", widget: { horizontalCenter: 95 }, callback: "onClickGetGold", script: this ,size: { height: 61, width: 61 } })
            ...
            hqq.setBtn(btnjchd, { normal: hlpath + "btnjchd", widget: { top: 15, right: 240 }, callback: "onClickJCHD", script: this })
            hqq.setBtn(btnqmdl, { normal: hlpath + "btnqmdl", widget: { top: 15, right: 115 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "btngonggao", widget: { top: 15, right: 40 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "btnshouyi", widget: { left: 0, bottom: 0 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "btnkefu", widget: { left: 188, bottom: 0 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "btnmfjb", widget: { left: 376, bottom: 0 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { normal: hlpath + "btnchongzhi", widget: { right: 0, bottom: 0 }, callback: "onClickCC", script: this })

            cc.find("Canvas/hallback/xinsheng/menuback").active = true;
            this.menuBtnListNode = cc.find("Canvas/hallback/xinsheng/xinshengmenu")
            let btn_all = this.menuBtnListNode.getChildByName("btn_all")
            btn_all.active = true;
            hqq.setBtn(btn_all, { normal: hlpath + "btn_all", pressed: hlpath + "btn_all1", custom: this.menuBtnInfoList[0], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            let btn_changyong = this.menuBtnListNode.getChildByName("btn_changyong")
            btn_changyong.active = true;
            hqq.setBtn(btn_changyong, { normal: hlpath + "btn_changyong", pressed: hlpath + "btn_changyong1", custom: this.menuBtnInfoList[1], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            btn_duizhan.active = true;
            hqq.setBtn(btn_duizhan, { normal: hlpath + "btn_duizhan", pressed: hlpath + "btn_duizhan1", custom: this.menuBtnInfoList[2], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
            btn_touzhu.active = true;
            hqq.setBtn(btn_touzhu, { normal: hlpath + "btn_touzhu", pressed: hlpath + "btn_touzhu1", custom: this.menuBtnInfoList[3], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
            btn_shixun.active = true;
            hqq.setBtn(btn_shixun, { normal: hlpath + "btn_shixun", pressed: hlpath + "btn_shixun1", custom: this.menuBtnInfoList[4], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_zuqiu")
            btn_zuqiu.active = true;
            hqq.setBtn(btn_zuqiu, { normal: hlpath + "btn_zuqiu", pressed: hlpath + "btn_zuqiu1", custom: this.menuBtnInfoList[5], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_jieji = this.menuBtnListNode.getChildByName("btn_jieji")
            btn_jieji.active = true;
            hqq.setBtn(btn_jieji, { normal: hlpath + "btn_jieji", pressed: hlpath + "btn_jieji1", custom: this.menuBtnInfoList[6], callback: "onClickMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let xinshengtitle = cc.find("Canvas/hallback/xinsheng/xinshengtitle");
            hqq.setSprite(xinshengtitle, { path: "hall/language/CN/xinlong/xinlongtitle" })
            
            hqq.addNode(this.node, { normal: "base/language/CN/img/vip_diamond", widget:{horizontalCenter:150,bottom:-10} ,callback:"toogleManyCai",script:this});

            this.noticepanel.active = true
        } else if (hqq.app.pinpai == "xinhao") { // 新豪
            let hlpath = "hall/language/" + hqq.language + "/img/"
            let hpath = "hall/test/"
            let hrpath = "hall/language/" + hqq.language + "/"
            this.youkeicon.x = 25
            this.youkeicon.y = 25
            hqq.setSprite(this.btngonggaopoint, { path: "hall/test/img/redpoint", position: { x: 30, y: 20 }, active: false })
            hqq.setSprite(this.jchdRedPoint, { path: "hall/test/img/redpoint", position: { x: 30, y: 20 }, active: false })
            ...
            hqq.setSprite(background, { path: hpath + "bigimg/roombgmin" })
            hqq.setBtn(touxiang, { path: hpath + "img/headfram2", widget: { top: 8, left: 10 }, callback: "onClickPlayerBtn", script: this })
            mask.getComponent(cc.Mask).spriteFrame = hqq.getSpriteFrame("hall/test/img/p_head_mask")
            hqq.setSprite(namebg, { path: hpath + "img/namebg", widget: { left: 50, top: 25 },width:175 })
            hqq.setSprite(goldback, { path: hpath + "img/sp_num_bg", widget: { left: 270, top: 20 } , width:260})
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 200, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "img/sp_coin2", widget: { horizontalCenter: -110 } })
            // hqq.setBtn(btncopy, { normal: hpath + "img/copyname", widget: { horizontalCenter: 107 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: "hall/test/img/btn_refresh2", widget: { horizontalCenter: 115 }, callback: "onClickGetGold", script: this ,size: { height: 61, width: 61 }})
            ...
            hqq.setBtn(btnjchd, { path: hrpath + "icon_jchd", aniname: "Animation1", loop: true, widget: { top: -5, right: 165 }, callback: "onClickJCHD", script: this })
            hqq.setBtn(btnqmdl, { path: hrpath + "quanming", aniname: "dating_qmdl", loop: true, widget: { top: 5, right: 70 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "icon_gonggao", widget: { top: 15, right: 18 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnkefu, { normal: hlpath + "icon_chat2", widget: { left: 70, bottom: 30 }, callback: "onClickKF", script: this })
            hqq.setBtn(this.btnshouyi, { normal: hlpath + "icon_duihuan", widget: { left: 245, bottom: 30 }, callback: "onClickSY", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "btnmfjb", widget: { left: 445, bottom: 30 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { path: hrpath + "chongzhi", aniname: "dating_chongzhi", loop: true, widget: { right: 0, bottom: -153 }, size: { width: 385, height: 255 }, callback: "onClickCC", script: this })
            ...
            let btn_all = this.menuBtnListNode.getChildByName("btn_all")
            hqq.setBtn(btn_all, { normal: hlpath + "btn_all", pressed: hlpath + "btn_all2", custom: this.menuBtnInfoList[0], callback: "onClickMenuBtn", script: this, interactable: false })
            let btn_changyong = this.menuBtnListNode.getChildByName("btn_changyong")
            hqq.setBtn(btn_changyong, { normal: hlpath + "btn_changyong", pressed: hlpath + "btn_changyong2", custom: this.menuBtnInfoList[1], callback: "onClickMenuBtn", script: this })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            hqq.setBtn(btn_duizhan, { normal: hlpath + "btn_duizhan", pressed: hlpath + "btn_duizhan2", custom: this.menuBtnInfoList[2], callback: "onClickMenuBtn", script: this })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
            hqq.setBtn(btn_touzhu, { normal: hlpath + "btn_touzhu", pressed: hlpath + "btn_touzhu2", custom: this.menuBtnInfoList[3], callback: "onClickMenuBtn", script: this })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
            hqq.setBtn(btn_shixun, { normal: hlpath + "btn_shixun", pressed: hlpath + "btn_shixun2", custom: this.menuBtnInfoList[4], callback: "onClickMenuBtn", script: this })
            let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_zuqiu")
            hqq.setBtn(btn_zuqiu, { normal: hlpath + "btn_zuqiu", pressed: hlpath + "btn_zuqiu2", custom: this.menuBtnInfoList[5], callback: "onClickMenuBtn", script: this })
            let btn_jieji = this.menuBtnListNode.getChildByName("btn_jieji")
            hqq.setBtn(btn_jieji, { normal: hlpath + "btn_jieji", pressed: hlpath + "btn_jieji2", custom: this.menuBtnInfoList[6], callback: "onClickMenuBtn", script: this })
            let pos = this.menuBtnListNode.children[0].getPosition().add(this.menuBtnListNode.getPosition())
            ...
            hqq.addNode(this.node, { path: hrpath+"xinhao/logo_dating", widget:{horizontalCenter:60,top:10} });
        } else if (hqq.app.pinpai == "juding" ) {
            ...
            hqq.setSprite(this.shouyipoint, { path: "hall/test/img/redpoint", position: { x: 0, y: 20 }, active: false })
            hqq.setSprite(this.kefupoint, { path: "hall/test/img/redpoint", position: { x: -5, y: 20 }, active: false })
            hqq.setSprite(background, { path: "base/juding/plaza_bg" })

            hqq.setLabel(this.namelabel, { string: "", widget: { left: -70 }, fontSize: 30 })
            hqq.setLabel(this.coinlabel, { string: "", fontSize: 35, widget: { horizontalCenter: -6 } })
            hqq.setBtn(touxiang, { path: hpath + "headframe", size: { height: 90, width: 90 }, widget: { top: 10, left: 10 }, callback: "onClickPlayerBtn", script: this })
            hqq.setSprite(namebg, { path: hpath + "namebg", widget: { left: 100, top: 20 }, size: { height: 40, width: 200 } })
            hqq.setSprite(goldback, { path: hpath + "namebg", widget: { horizontalCenter: 0, top: 18 }, size: { width: 300 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 190, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "sp_coin", widget: { horizontalCenter: -125 } })

            hqq.setBtn(btncopy, { normal: hpath + "profile_edit", widget: { horizontalCenter: 80 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: hpath + "btn_refresh", widget: { horizontalCenter: 120 }, callback: "onClickGetGold", script: this ,size: { height: 47, width: 46 }})

            hqq.setBtn(btnqmdl, { normal: hlpath + "icon_daili", widget: { top: 15, right: 120 }, callback: "onClickQMDL", script: this })
            hqq.setBtn(btnjchd, { normal: hlpath + "icon_jchd", widget: { top: 15, right:10  }, callback: "onClickJCHD", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "icon_gonggao", widget: { top: 15, right:230 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "icon_duihuan", widget: { left: 80, bottom: 5 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "icon_chat", widget: { left: 320, bottom: 5 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnmfjb, { normal: hlpath + "icon_mailBox", widget: { left: 560, bottom: 5 }, callback: "onClickMFJB", script: this })
            hqq.setBtn(btnchongzhi, { path:"hall/language/CN/jd_ani_chongzhi",widget: { right: 0, bottom: 0 }, callback: "onClickCC", script: this , aniname:"animation",loop:true})

            hqq.setSkeleton(cc.find("Canvas/hallback/juding/menu/jd_ani_menu_title"),{path:"hall/language/CN/jd_ani_menu_title",aniname:"animation",loop:true,x:161,y:193})
            ...
            hqq.setSkeleton(cc.find("Canvas/hallback/juding/menu/dating_menu_di/dating_btn_select_di/jd_ani_btn_select"),{path:"hall/language/CN/jd_ani_btn_select",aniname:"animation",loop:true})
            let btn_all = this.menuBtnListNode.getChildByName("btn_all")
            hqq.setBtn(btn_all, { normal: hlpath + "btn_allgames", pressed: hlpath + "btn_allgames2", custom: this.menuBtnInfoList[5], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            hqq.setBtn(btn_duizhan, { normal: hlpath + "btn_boardgames", pressed: hlpath + "btn_boardgames2", custom: this.menuBtnInfoList[1], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
            hqq.setBtn(btn_touzhu, { normal: hlpath + "btn_lottery", pressed: hlpath + "btn_lottery2", custom: this.menuBtnInfoList[4], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_dianzi")
            hqq.setBtn(btn_shixun, { normal: hlpath + "btn_videogames", pressed: hlpath + "btn_videogames2", custom: this.menuBtnInfoList[2], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_tiyu")
            hqq.setBtn(btn_zuqiu, { normal: hlpath + "btn_sports", pressed: hlpath + "btn_sports2", custom: this.menuBtnInfoList[3], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_remen = this.menuBtnListNode.getChildByName("btn_remen") // 热门
            hqq.setBtn(btn_remen, { normal: hlpath + "btn_hotgames", pressed: hlpath + "btn_hotgames2", custom: this.menuBtnInfoList[0], callback: "onClickJudingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            ...
            hqq.setSkeleton(panel.getChildByName("sp_trumpet"), { path:"hall/juding/jd_ani_trumpet", x: -375 , aniname:"animation",loop:true})
            ...
            hqq.setLabel(this.namelabel, { string: "", widget: { left: -70 }, fontSize: 30 })
            hqq.setLabel(this.coinlabel, { string: "", fontSize: 35, widget: { horizontalCenter: -6 } })
            hqq.setBtn(touxiang, { path: hpath + "txk", height: 90, width: 90, widget: { top: 10, left: 10 }, callback: "onClickPlayerBtn", script: this })
            hqq.setNode(touxiang.getChildByName("mask"),{height: 80, width: 80})
            hqq.setNode(this.head,{height: 90, width: 90});
            this.youkeicon.x = 30
            this.youkeicon.y = 30
            hqq.setSprite(namebg, { path: hpath + "d3", widget: { left: 100, top: 20 }, size: { height: 40, width: 200 } })
            hqq.setSprite(goldback, { path: hpath + "d3", widget: { left:400, top: 18 }, size: { width: 300 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 190, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: "hall/test/img/sp_coin2", widget: { horizontalCenter: -125 } })

            hqq.setBtn(btncopy, { normal: hpath + "xg", widget: { horizontalCenter: 80 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: hpath + "sx", widget: { horizontalCenter: 120 }, callback: "onClickGetGold", script: this ,size: { height: 47, width: 46 }})

            hqq.setBtn(btnqmdl, { normal: hlpath + "qmdl", widget: { top: 15, right: 10 }, callback: "onClickQMDL", script: this })
            // btnqmdl.active = false;
            hqq.setBtn(btnjchd, { normal: hlpath + "jchd", widget: { top: 15, right:120  }, callback: "onClickJCHD", script: this })
            // hqq.setBtn(this.btngonggao, { normal: hlpath + "gg", widget: { top: 15, right:120 }, callback: "onClickGG", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "gg", widget: { top: 15, right:230 }, callback: "onClickGG", script: this })

            hqq.setBtn(this.btnshouyi, { normal: hlpath + "dh", widget: { left: 280, bottom: 5 }, callback: "onClickSY", script: this })
            hqq.setBtn(this.btnkefu, { normal: hlpath + "kf", widget: { left: 80, bottom: 5 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnchongzhi, { normal:hpath + "cz1",widget: { right: 0, bottom: 10 }, callback: "onClickCC", script: this})
            ...
            let btn_all = this.menuBtnListNode.getChildByName("btn_all")
            hqq.setBtn(btn_all, { normal: hlpath + "all", pressed: hlpath + "all1", custom: this.menuBtnInfoList[0], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            let btn_changyong = this.menuBtnListNode.getChildByName("btn_changyong")
            hqq.setBtn(btn_changyong, { normal: hlpath + "changyong", pressed: hlpath + "changyong1", custom: this.menuBtnInfoList[1], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
            hqq.setBtn(btn_duizhan, { normal: hlpath + "duizhan", pressed: hlpath + "duizhan1", custom: this.menuBtnInfoList[2], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_dianzi = this.menuBtnListNode.getChildByName("btn_dianzi")
            hqq.setBtn(btn_dianzi, { normal: hlpath + "dianzi", pressed: hlpath + "dianzi1", custom: this.menuBtnInfoList[6], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
            hqq.setBtn(btn_shixun, { normal: hlpath + "shixun", pressed: hlpath + "shixun1", custom: this.menuBtnInfoList[4], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_tiyu = this.menuBtnListNode.getChildByName("btn_tiyu") // 热门
            hqq.setBtn(btn_tiyu, { normal: hlpath + "tiyu", pressed: hlpath + "tiyu1", custom: this.menuBtnInfoList[3], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu") // 热门
            hqq.setBtn(btn_touzhu, { normal: hlpath + "touzhu", pressed: hlpath + "touzhu1", custom: this.menuBtnInfoList[5], callback: "onClickHuaxingMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            ...
            let scroll = panel.getChildByName("noticescroll")
            scroll.x = 10
            hqq.setSprite(panel, { path: hpath + "dk1", y:-120})
            hqq.setSkeleton(panel.getChildByName("sp_trumpet"), { path:"hall/juding/jd_ani_trumpet", x: -375 , aniname:"animation",loop:true})
            ...
            let hlpath2 = "hall/language/" + hqq.language + "/ninetwo/"
            ...
            hqq.addNode(touxiang, { normal: hlpath2 + "dating_headFrame",aniname:"touxiankuang_small",loop:true, height: 76, width: 76, widget: { top: -30, left: -30 }, callback: "onClickPlayerBtn", script: this ,zIndex:-1})
            
            this.youkeicon.x = 30
            this.youkeicon.y = 30
            hqq.setNode(namebg, { widget: { left: 170, top: 5 } })
            hqq.setSprite(goldback, { path: hpath + "kuang", widget: { right:150, top: 18 }, size: { width: 300 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 190, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "jinbi", widget: { horizontalCenter: -125 } })

            // hqq.setBtn(btncopy, { normal: hpath + "xg", widget: { horizontalCenter: 80 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: hpath + "zhuanhuan", widget: { horizontalCenter: 140 }, callback: "onClickGetGold", script: this ,size: { height: 54, width: 53 }})

            hqq.setBtn(btnqmdl, { path: hlpath2 + "dating_btn_promote/",aniname:"animation",loop:true, widget: { bottom: 20, left: 50 , closetop:true, closeright:true}, callback: "onClickQMDL", script: this })
            // btnqmdl.active = false;
            hqq.setBtn(btnjchd, { normal: hlpath + "huodong", widget: { closetop: true,bottom: 18, left:300,closeright:true  }, callback: "onClickJCHD", script: this })
            // hqq.setBtn(this.btngonggao, { normal: hlpath + "gg", widget: { top: 15, right:120 }, callback: "onClickGG", script: this })
            hqq.setBtn(this.btngonggao, { normal: hlpath + "gg", widget: { closetop: true,bottom: 25, right:700 }, callback: "onClickGG", script: this })

            hqq.addNode(cc.find("Canvas"), { normal:hlpath2 + "dating_btn_withdrawal/",aniname:"animation",loop:true,widget: { right: 200 , bottom: 20 , closeleft:true}, callback: "onClickSY", script: this})
            hqq.setBtn(this.btnkefu, { normal: hlpath + "kefu", widget: { closeleft:true, bottom: 20 , right:500 }, callback: "onClickKF", script: this })
            hqq.setBtn(btnchongzhi, { path:hlpath2 + "dating_btn_recharge/",aniname:"animation",loop:true,widget: { right: 10 , bottom: 20 }, callback: "onClickCC", script: this})
            ...
            hqq.setBtn(btn_all, { normal: hlpath + "quanbuyouxi1", pressed: hlpath + "quanbuyouxi2", custom: this.menuBtnInfoList[0], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE, interactable: false })
            let btn_changyong = cc.find("menuScrollView/view/content/btn_changyong",this.menuBtnListNode);
            hqq.setBtn(btn_changyong, { normal: hlpath + "changyongyouxi1", pressed: hlpath + "changyongyouxi2", custom: this.menuBtnInfoList[1], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_duizhan = cc.find("menuScrollView/view/content/btn_duizhan",this.menuBtnListNode);
            hqq.setBtn(btn_duizhan, { normal: hlpath + "qipaiyouxi1", pressed: hlpath + "qipaiyouxi2", custom: this.menuBtnInfoList[2], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_dianzi = cc.find("menuScrollView/view/content/btn_dianzi",this.menuBtnListNode);
            hqq.setBtn(btn_dianzi, { normal: hlpath + "dianziyouxi1", pressed: hlpath + "dianziyouxi2", custom: this.menuBtnInfoList[6], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_shixun = cc.find("menuScrollView/view/content/btn_shixun",this.menuBtnListNode);
            hqq.setBtn(btn_shixun, { normal: hlpath + "zhenrenshixun1", pressed: hlpath + "zhenrenshixun2", custom: this.menuBtnInfoList[4], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_tiyu = cc.find("menuScrollView/view/content/btn_tiyu",this.menuBtnListNode);
            hqq.setBtn(btn_tiyu, { normal: hlpath + "tiyusaishi1", pressed: hlpath + "tiyusaishi2", custom: this.menuBtnInfoList[3], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            let btn_touzhu = cc.find("menuScrollView/view/content/btn_touzhu",this.menuBtnListNode);
            hqq.setBtn(btn_touzhu, { normal: hlpath + "caipiaotouzh1", pressed: hlpath + "caipiaotouzh2", custom: this.menuBtnInfoList[5], callback: "onClickNinetwoMenuBtn", script: this, transition: cc.Button.Transition.SPRITE })
            ...
            hqq.addNode(this.node, { normal: "base/language/CN/img/vip_diamond", widget:{horizontalCenter:220,bottom:-10} ,callback:"toogleManyCai",script:this});
            hqq.addNode(this.node, { skeleton: hlpath2+"dating_title/",aniname:"animation",loop:true, widget:{horizontalCenter:60,top:10} });
            hqq.addNode(this.node,{ path:hpath+"xian",widget:{bottom:5,left:270}})
            hqq.addNode(this.node,{ path:hpath+"xian",widget:{bottom:5,right:390}})
            hqq.setWidget(subgameview, { left: 310 ,top:100,bottom:60})
            hqq.addNode(this.node,{normal:hlpath+"djc",widget:{left:400,top:10}});
            hqq.addNode(this.node,{normal:hlpath+"shezhi",widget:{right:10,top:10},callback:"onClickSheZhi",script:this});
            this.noticepanel.active = true
        } else {
            let hlpath = "hall/language/" + hqq.language + "/img/"
            let hpath = "hall/test/"
            ...
            hqq.setLabel(this.coinlabel, { string: "" })
            hqq.setSprite(background, { path: hpath + "bigimg/roombgmin" })
            hqq.setBtn(touxiang, { path: hpath + "img/headfram2", widget: { top: 8, left: 20 }, callback: "onClickPlayerBtn", script: this })
            mask.getComponent(cc.Mask).spriteFrame = hqq.getSpriteFrame("hall/test/img/p_head_mask")
            hqq.setSprite(namebg, { path: hpath + "img/namebg", widget: { left: 100, top: 25 } })
            hqq.setSprite(goldback, { path: hpath + "img/sp_num_bg", widget: { horizontalCenter: 0, top: 20 } })
            // hqq.addNode(goldback, { normal: "hall/test/img/refresh", callback: "onClickGetGold", script: this, x: 200, size: { width: 35, height: 35 } })
            hqq.setSprite(jinbi, { path: hpath + "img/sp_coin2", widget: { horizontalCenter: -140 } })
            hqq.setBtn(btncopy, { normal: hpath + "img/copyname", widget: { horizontalCenter: 107 }, callback: "onClickPlayerBtn", script: this })
            hqq.setBtn(btnplus, { normal: "hall/test/img/btn_refresh2", widget: { horizontalCenter: 145 }, callback: "onClickGetGold", script: this ,size: { height: 61, width: 61 }})
            ...
            if (hqq.app.pinpai == "yuyu" || hqq.app.pinpai == "nineone") {
                ...
                hqq.setSprite(yuyuad, { path: hrpath + "yuyu/yuyu_ad" , x:175})
                let btn_all = cc.find("Canvas/hallback/yuyu/menu/btn_all")
                hqq.setBtn(btn_all, { normal: hrpath + "yuyu/btn_all", pressed: hrpath + "yuyu/btn_all2", custom: this.menuBtnInfoList[0], callback: "onClickYuyuMenuBtn", script: this , transition: cc.Button.Transition.SPRITE, interactable: false})
                let btn_changyong = cc.find("Canvas/hallback/yuyu/menu/btn_changyong")
                hqq.setBtn(btn_changyong, { normal: hrpath + "yuyu/btn_changyong", pressed: hrpath + "yuyu/btn_changyong2", custom: this.menuBtnInfoList[1], callback: "onClickYuyuMenuBtn", script: this , transition: cc.Button.Transition.SPRITE})
                let btn_duizhan = cc.find("Canvas/hallback/yuyu/menu/btn_duizhan")
                hqq.setBtn(btn_duizhan, { normal: hrpath + "yuyu/btn_duizhan", pressed: hrpath + "yuyu/btn_duizhan2", custom: this.menuBtnInfoList[2], callback: "onClickYuyuMenuBtn", script: this , transition: cc.Button.Transition.SPRITE})
                let btn_touzhu = cc.find("Canvas/hallback/yuyu/menu/btn_touzhu")
                hqq.setBtn(btn_touzhu, { normal: hrpath + "yuyu/btn_touzhu", pressed: hrpath + "yuyu/btn_touzhu2", custom: this.menuBtnInfoList[3], callback: "onClickYuyuMenuBtn", script: this ,x:395.671, transition: cc.Button.Transition.SPRITE})
                let btn_shixun = cc.find("Canvas/hallback/yuyu/menu/btn_shixun")
                hqq.setBtn(btn_shixun, { normal: hrpath + "yuyu/btn_shixun", pressed: hrpath + "yuyu/btn_shixun2", custom: this.menuBtnInfoList[4], callback: "onClickYuyuMenuBtn", script: this , transition: cc.Button.Transition.SPRITE})
                let btn_zuqiu = cc.find("Canvas/hallback/yuyu/menu/btn_zuqiu")
                hqq.setBtn(btn_zuqiu, { normal: hrpath + "yuyu/btn_zuqiu", pressed: hrpath + "yuyu/btn_zuqiu2", custom: this.menuBtnInfoList[5], callback: "onClickYuyuMenuBtn", script: this , transition: cc.Button.Transition.SPRITE})
                let btn_jieji = cc.find("Canvas/hallback/yuyu/menu/btn_jieji")
                hqq.setBtn(btn_jieji, { normal: hrpath + "yuyu/btn_jieji", pressed: hrpath + "yuyu/btn_jieji2", custom: this.menuBtnInfoList[6], callback: "onClickYuyuMenuBtn", script: this ,x:1.365, transition: cc.Button.Transition.SPRITE})
                ...
                hqq.setBtn(btn_changyong, { normal: hlpath + "btn_changyong", pressed: hlpath + "btn_changyong2", custom: this.menuBtnInfoList[1], callback: "onClickMenuBtn", script: this })
                let btn_duizhan = this.menuBtnListNode.getChildByName("btn_duizhan")
                hqq.setBtn(btn_duizhan, { normal: hrpath + "huangshi/btn_qipai", pressed: hrpath + "huangshi/btn_qipai2", custom: this.menuBtnInfoList[2], callback: "onClickMenuBtn", script: this })
                let btn_touzhu = this.menuBtnListNode.getChildByName("btn_touzhu")
                hqq.setBtn(btn_touzhu, { normal: hrpath + "huangshi/btn_tiyu", pressed: hrpath + "huangshi/btn_tiyu2", custom: this.menuBtnInfoList[3], callback: "onClickMenuBtn", script: this , y:-182.714})
                let btn_shixun = this.menuBtnListNode.getChildByName("btn_shixun")
                hqq.setBtn(btn_shixun, { normal: hlpath + "btn_shixun", pressed: hlpath + "btn_shixun2", custom: this.menuBtnInfoList[4], callback: "onClickMenuBtn", script: this })
                let btn_zuqiu = this.menuBtnListNode.getChildByName("btn_zuqiu")
                hqq.setBtn(btn_zuqiu, { normal: hrpath + "huangshi/btn_caipiao", pressed: hrpath + "huangshi/btn_caipiao2", custom: this.menuBtnInfoList[5], callback: "onClickMenuBtn", script: this })
                let btn_jieji = this.menuBtnListNode.getChildByName("btn_jieji")
                hqq.setBtn(btn_jieji, { normal: hrpath + "huangshi/btn_dianzi", pressed: hrpath + "huangshi/btn_dianzi2", custom: this.menuBtnInfoList[6], callback: "onClickMenuBtn", script: this , y:1.435})
                let pos = this.menuBtnListNode.children[0].getPosition().add(this.menuBtnListNode.getPosition())
                this.btnMenuSelect.x = pos.x
                this.btnMenuSelect.y = pos.y
        ...
        if( hqq.app.pinpai != "ninetwo" ){
            hqq.addNode(this.node,{string:"version:"+hqq.app.version,widget:{bottom:0,right:10},fontSize:15,lineHeight:18});
        }
        this.scheduleOnce(() => {
            this.startInit();
            this.onClickGetGold()
    ...
    onClickXinguiMenuBtn(event, customEventData) {
        // console.log("onClickXinguiMenuBtn", customEventData, event.target.customIndex)
        if (this.isMenuRun) {
            return
        }
        this.isMenuRun = true
        let path = "hall/xingui/img/js"
        for (let i = 0; i < this.menuBtnInfoList.length; i++) {
            if (customEventData.match(this.menuBtnInfoList[i])) {
                this.beauty
                hqq.setSprite(this.beauty, { path: path + (i + 1) })
                break
            }
        }
    ...
    UISetHBY() {
        if (hqq.app.pinpai == "fuxin" ) {
            hqq.setBtn(this.btnhby, { normal: "hall/language/" + hqq.language + "/fuxin/icon1", widget: { top: 11, right: 510 }, callback: "onClickHBY", script: this })
        } else if (hqq.app.pinpai == "xingui") {
            hqq.setBtn(this.btnhby, { normal: "hall/language/" + hqq.language + "/xingui/btn_hby", widget: { top: 11, right: 390 }, callback: "onClickHBY", script: this })
        } else if (hqq.app.pinpai == "xinsheng") {
            hqq.setBtn(this.btnhby, { normal: "hall/language/" + hqq.language + "/xinsheng/img/btnhby", widget: { top: 11, right: 350 }, callback: "onClickHBY", script: this })
        } else if(hqq.app.pinpai == "xinhao"){
            hqq.setBtn(this.btnhby, { path: "hall/language/" + hqq.language + "/dating_hby", aniname: "animation", loop: true, widget: { top: -15 , right: 260 }, callback: "onClickHBY", script: this })
        } else if(hqq.app.pinpai == "juding"){
            hqq.setBtn(this.btnhby, { normal: "hall/language/" + hqq.language + "/icon_hby", widget: { top: 36, right: 350 }, callback: "onClickHBY", script: this })
        } else {
            hqq.setBtn(this.btnhby, { path: "hall/language/" + hqq.language + "/dating_hby", aniname: "animation", loop: true, widget: { top: -20, right: 260 }, callback: "onClickHBY", script: this })
        }
    },
    // 显示积分抽奖按钮
    UISetJFCJ() {
        if (hqq.app.pinpai == "fuxin" ) {
            hqq.setBtn(this.btnjfcj, { normal: "hall/language/" + hqq.language + "/fuxin/icon4", widget: { top: 28, right: 390 }, callback: "onClickJFCJ", script: this })
        } else if (hqq.app.pinpai == "xingui") {
            hqq.setBtn(this.btnjfcj, { normal: "hall/language/" + hqq.language + "/xingui/btn_jfcj", widget: { top: 11, right: 510 }, callback: "onClickJFCJ", script: this })
        } else if (hqq.app.pinpai == "xinsheng") {
            hqq.setBtn(this.btnjfcj, { normal: "hall/language/" + hqq.language + "/xinsheng/img/btnjfcj", widget: { top: 15, right: 355 }, callback: "onClickJFCJ", script: this })
        } else if(hqq.app.pinpai == "xinhao"){
            hqq.setBtn(this.btnjfcj, { path: "hall/language/" + hqq.language + "/dating_jfcj", aniname: "animation", loop: true, widget: { top: 45, right: 450 }, callback: "onClickJFCJ", script: this })
        } else if(hqq.app.pinpai == "juding"){
            hqq.setBtn(this.btnjfcj, { normal: "hall/language/" + hqq.language + "/icon_jfcj", widget: { top: 15, right: 510 }, callback: "onClickJFCJ", script: this })
        } else {
            hqq.setBtn(this.btnjfcj, { path: "hall/language/" + hqq.language + "/dating_jfcj", aniname: "animation", loop: true, widget: { top: 0, right: 350 }, callback: "onClickJFCJ", script: this })
        }
    },
    // 最先注册，及时监听来自子游戏的退出事件
    startInit() {
    ...
    isupdataCallback(bool, enname) {
        if (bool) { // 需要更新 自动更新，无需处理
            if( hqq.app.pinpai == "xinhao" || hqq.app.pinpai == "xinsheng" ){
                if (enname == "lhd")     {enname = "lhd2"}
                else if (enname == "ebg")     {enname = "ebg2"}
                else if (enname == "zjh")     {enname = "zjh2"}
                else if (enname == "hbld")    {enname = "hbld2"}
                else if (enname == "suoha")   {enname = "suoha2"}
                else if (enname == "szwg")    {enname = "szwg2"}
                else if (enname == "brnn")    {enname = "brnn2"}
                else if (enname == "ddz")     {enname = "ddz2"}
                else if (enname == "bcbm")    {enname = "bcbm2"}
                else if (enname == "hh")      {enname = "hh2"}
                else if (enname == "dzpk")    {enname = "dzpk2"}
                else if (enname == "shaibao") {enname = "shaibao2"}
                else if (enname == "sss")     {enname = "sss2"}
                // else if (enname == "ermj")    {enname = "ermj2"}
                // else if (enname == "pdk")     {enname = "pdk2"}
                // else if (enname == "21d")     {enname = "21d2"}
                else if (enname == "bjl")     {enname = "bjl2"}
                else if (enname == "lp")      {enname = "lp2"}
                else if (enname == "qznn")    {enname = "qznn2"}
            }
            if (enname == "zrsx") {
    ...
    */
    ...
    loadIconRes(node, name, key, i) {
        if (hqq.app.pinpai == "fuxin" ) {
            let path = "hall/language/" + hqq.language + "/" + "xinsheng/img/icon" + this.subGameList[key].enname
            if (this.subGameList[key].enname == "cdx" || this.subGameList[key].enname == "fctbj" ) {
                path = "hall/language/" + hqq.language + "/" + "fuxin" + "/icon" + this.subGameList[key].enname
            }
            let temp = i % 6;
            let num = (i % 2) == 0 ? (temp == 0 ? 1 : temp == 2 ? 2 : 3) : (temp == 1 ? 4 : temp == 3 ? 5 : 6)
            hqq.setSprite(node, { normal: "hall/fuxin/img/" + num, size: { width: 230, height: 230 } })
            hqq.addNode(node, { path: path, scale: 0.8 })
            ...
            if(hqq.game2to1[ this.subGameList[key].enname]){
                path = "hall/language/" + hqq.language + "/" + "xinsheng/img/icon" + hqq.game2to1[ this.subGameList[key].enname]
            }
            hqq.setSprite(node, { normal: path })
        } else if (hqq.app.pinpai == "xingui") {
            let path = "hall/language/" + hqq.language + "/" + "xinsheng/img/icon" + this.subGameList[key].enname
            if (this.subGameList[key].enname == "cylhd" || this.subGameList[key].enname == "szwg"
                || this.subGameList[key].enname == "sbty2" || this.subGameList[key].enname == "zrsx1"
                || this.subGameList[key].enname == "zrsx2") {
                path = "hall/language/" + hqq.language + "/" + "xingui" + "/icon" + this.subGameList[key].enname
            }
            hqq.setSprite(node, { normal: path })
        } else if (hqq.app.pinpai == "juding" ) {
            let path = "hall/language/" + hqq.language + "/juding/icon" + this.subGameList[key].enname
            hqq.setSprite(node, { normal: path ,size: { width: 318*0.81, height: 280*0.81 } })
            let tempbool = node.parent.active;
            if(!tempbool){
                node.parent.active = true;
            }
            ...
            let path = "hall/language/" + hqq.language + "/huaxing/icon" + this.subGameList[key].enname
            hqq.setSprite(node, { normal: path ,size: { width: 230, height: 209 } })
            let tempbool = node.parent.active;
            if(!tempbool){
                node.parent.active = true;
            }
            ...
            let path = "hall/language/" + hqq.language + "/ninetwo/img/icon" + this.subGameList[key].enname
            let path2 = "hall/language/" + hqq.language + "/ninetwo/bigicon/icon" + this.subGameList[key].enname
            hqq.setSprite(node, { normal: path ,width: 217, height: 224})
            let tempbool = node.parent.active;
            if(!tempbool){
                node.parent.active = true;
            }
            if( key in this.ninetwothirdlist ){
                hqq.getSpriteFrame(path2)
            } 
            if(!tempbool){
                node.parent.active = false;
            }
            ...
            hqq.setSkeleton(node, { name:key , path: path, aniname: "animation", loop: true ,premultipliedAlpha:key=="pg2"})
            let namepath = "/hall/language/" + hqq.language + path.substring(path.indexOf("/btnanimation"))
            hqq.setSprite(name, { name:key,path: namepath + "/name" })
        }
    },
        ...
        if( hqq.app.pinpai == "fuxin" ){
            ...
            for (let key in this.subGameList){
                ...
                if(cc.isValid(ani)){
                    ...
                    if( (ani.x < tempx || ani.x > tempx2)){
                        if(ani.active){
                            if(( pos.x > this.scrollviewcotentX && (ani.x == 143.5 || ani.x == 348.5 || ani.x == 553.5|| ani.x == 430.5) )){
                                ani.active = true;
                            } else{
                                ani.active = false;
                            }
        ...
        for (let i = 0; i<sortArray.length;i++) {
            ...
            this.scheduleOnce(()=>{
                ...
                if (hqq.app.pinpai == "xinsheng" || hqq.app.pinpai == "xingui" || hqq.app.pinpai == "xinlong" ) {
                    ...
                    hqq.setSprite(itemhot, { path: "hall/language/" + hqq.language + "/xinsheng/img/hot", position: { x: -60, y: 57 } })
                    hqq.setSprite(itemwait, { path: "hall/language/" + hqq.language + "/xinsheng/img/wait", position: { x: -50, y: 57 } })
                    hqq.setSprite(itemexp, { path: "hall/language/" + hqq.language + "/xinsheng/img/experience", position: { x: -50, y: 57 } })
                    ...
                    hqq.setNode(itembtn.downflag, { opacity: 200 })
                    hqq.setNode(itembtn.progress, { opacity: 100 })

                    hqq.setSprite(itemhot, { path: "hall/language/" + hqq.language + "/img/hot" })
                    hqq.setSprite(itemwait, { path: "hall/language/" + hqq.language + "/img/wait" })
                    hqq.setSprite(itemexp, { path: "hall/language/" + hqq.language + "/img/experience" })
                    if(key=="pg2"){
                        hqq.addNode(itembtn,{path: "hall/language/" + hqq.language + "/img/vipLine",x:-97,y:57,name:"pg1"});
                        hqq.addNode(itembtn,{path: "hall/language/" + hqq.language + "/img/icon_pgOfficial",x:100,y:85,name:"pg2"});
                    }
                    ...
                    itembtn.scale = 1.2
                    hqq.setNode(itembtn.progress, { opacity: 100 })
                    hqq.setSprite(itemhot, { path: "hall/language/" + hqq.language + "/ninetwo/img/huo" ,position: { x: -55, y: 57 }})
                    hqq.setSprite(itemwait, { path: "hall/language/" + hqq.language + "/ninetwo/img/jing" , position: { x: -15, y: 57 }})
                    hqq.setSprite(itemexp, { path: "hall/language/" + hqq.language + "/ninetwo/img/ti" , position: { x: -30, y: 57 }})
                ...
                if (hqq.hotUpdateMgr.getSubGameIsOnUp(tempdata.enname)) { // 子游戏在更新列表中
                    ...
                    else if (tempdata.enname == "lhd2")     {subgamern = "lhd";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "ebg2")     {subgamern = "ebg";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "zjh2")     {subgamern = "zjh";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "hbld2")    {subgamern = "hbld";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "suoha2")   {subgamern = "suoha";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "szwg2")    {subgamern = "szwg";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "brnn2")    {subgamern = "brnn";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "ddz2")     {subgamern = "ddz";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "bcbm2")    {subgamern = "bcbm";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "hh2")      {subgamern = "hh";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "dzpk2")    {subgamern = "dzpk";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "shaibao2") {subgamern = "shaibao";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "sss2")     {subgamern = "sss";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "ermj2")    {subgamern = "ermj";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "pdk2")     {subgamern = "pdk";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "21d2")     {subgamern = "21d";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "bjl2")     {subgamern = "bjl";this.loadBundle(subgamern);}
                    else if (tempdata.enname == "lp2")      {subgamern = "lp";this.loadBundle(subgamern);} 
                    else if (tempdata.enname == "qznn2")    {subgamern = "qznn";this.loadBundle(subgamern);} 
                    else {
                        this.loadBundle(subgamern)
                    }
    ...
    checkSubGameDownload(enname) {
        let enname2 = enname;
        if (enname == "lhd2")          {enname = "lhd";}
        else if (enname == "ebg2")     {enname = "ebg";}
        else if (enname == "zjh2")     {enname = "zjh";}
        else if (enname == "hbld2")    {enname = "hbld";}
        else if (enname == "suoha2")   {enname = "suoha";}
        else if (enname == "szwg2")    {enname = "szwg";}
        else if (enname == "brnn2")    {enname = "brnn";}
        else if (enname == "ddz2")     {enname = "ddz";}
        else if (enname == "bcbm2")    {enname = "bcbm";}
        else if (enname == "hh2")      {enname = "hh";}
        else if (enname == "dzpk2")    {enname = "dzpk";}
        else if (enname == "shaibao2") {enname = "shaibao";}
        else if (enname == "sss2")     {enname = "sss";}
        else if (enname == "ermj2")    {enname = "ermj";}
        else if (enname == "pdk2")     {enname = "pdk";}
        else if (enname == "21d2")     {enname = "21d";}
        else if (enname == "bjl2")     {enname = "bjl";}
        else if (enname == "lp2")      {enname = "lp";}
        else if (enname == "qznn2")    {enname = "qznn";}
    ...
    onClickPlayerBtn(event) {
        ...
        if( hqq.app.pinpai == "ninetwo" ){
            hqq.eventMgr.dispatch(hqq.eventMgr.showPersonalCenter, true)
        } else{
    ...
    jumpToSubGame(enname) {
        ...
        else if (enname == "lhd2")     {key = "lhd"}
        else if (enname == "ebg2")     {key = "ebg"}
        else if (enname == "zjh2")     {key = "zjh"}
        else if (enname == "hbld2")    {key = "hbld"}
        else if (enname == "suoha2")   {key = "suoha"}
        else if (enname == "szwg2")    {key = "szwg"}
        else if (enname == "brnn2")    {key = "brnn"}
        else if (enname == "ddz2")     {key = "ddz"}
        else if (enname == "bcbm2")    {key = "bcbm"}
        else if (enname == "hh2")      {key = "hh"}
        else if (enname == "dzpk2")    {key = "dzpk"}
        else if (enname == "shaibao2") {key = "shaibao"}
        else if (enname == "sss2")     {key = "sss"}
        else if (enname == "ermj2")    {key = "ermj"}
        else if (enname == "pdk2")     {key = "pdk"}
        else if (enname == "21d2")     {key = "21d"}
        else if (enname == "bjl2")     {key = "bjl"}
        else if (enname == "lp2")      {key = "lp"}
        else if (enname == "qznn2")    {key = "qznn"}
        hqq.audioMgr.stopBg();
        ...
        if (this.subGameList[enname] && this.subGameList[enname].hasRes) {
            if (!cc.assetManager.getBundle(key + "Res")) {
                cc.assetManager.loadBundle(key + "Res", (err) => {
                    if (err) {
                        return console.error(err);
                    }
                    hqq[key + 'Res'] = cc.assetManager.getBundle(key + "Res");
                    console.log('load subpackage script successfully.', key + 'Res', key + "Res");
    ...
    showHBYAni() {
        ...
        if (hqq.app.pinpai == "xinsheng" || hqq.app.pinpai == "xinlong") {
            hqq.setSkeleton(this.anilayer.getChildByName('rain'), { path: "hall/language/" + hqq.language + "/xinshenghby", aniname: "hb_rain", loop: true })
            hqq.setSkeleton(ani2, { path: "hall/language/" + hqq.language + "/xinshenghby", aniname: "hb_click", loop: true })
        } else {
            hqq.setSkeleton(this.anilayer.getChildByName('rain'), { path: "hall/ani_hongbaoyu", aniname: "hb_rain", loop: true })
            hqq.setSkeleton(ani2, { path: "hall/ani_hongbaoyu", aniname: "hb_click", loop: true })
        }
        ...
        let callback = (gold) => {
            if (hqq.app.pinpai == "xinsheng" || hqq.app.pinpai == "xinlong") {
                hqq.setSprite(z1, { path: "hall/language/" + hqq.language + "/xinshenghby/z1" })
                hqq.setBtn(btn_close, { path: "hall/language/" + hqq.language + "/xinshenghby/btn_close" })
            } else {
                hqq.setSprite(z1, { path: "hall/language/" + hqq.language + "/img/z1" })
                hqq.setBtn(btn_close, { path: "hall/test/img/btn_close" })
            }
    ...
    onClickQMDL(event, customEventData) {
        ...
        if (hqq.subModel.proxy.lanchscene != "") {
            cc.director.preloadScene(hqq.subModel.proxy.lanchscene, this.preloadSceneOnProgress.bind(this), (err, scene) => {
                if (err) {
                    console.log(err)
                    hqq.logMgr.logerror(err)
                    return
    ...
    onClickGG(event, customEventData) {
        console.log("onClickGG")
        // hqq.eventMgr.dispatch(hqq.eventMgr.showSamlllayer, { type: 13 })
        // return;
        ...
        if (state == this.subGameBtnState.needDown) { // 需要下载状态
            ...
            if(enname=="pg2"&&hqq.app.pinpai != "fuxin"&&hqq.app.pinpai != "xingui"&&
               ...
               hqq.app.pinpai != "huaxing"){
                this.subGameBtnMap[enname].getChildByName("pg1").active = false;
                this.subGameBtnMap[enname].getChildByName("pg2").active = false;
            }
            this.subGameList[enname].isDown = false
            if(hqq.app.pinpai=="juding"){
                this.subGameBtnMap[enname].downflag2.active = true;
        ...
        let mycallback = () => {
            ...
            if (mainversion != hqq.app.subGameVersion.hall) {
                ...
                if (enname == "zrsx1" || enname == "zrsx2") {
                    ...
                    subgamern = "jdb"
                } else if (enname == "lhd2")     {subgamern = "lhd";}
                else if (enname == "ebg2")     {subgamern = "ebg";}
                else if (enname == "zjh2")     {subgamern = "zjh";}
                else if (enname == "hbld2")    {subgamern = "hbld";}
                else if (enname == "suoha2")   {subgamern = "suoha";}
                else if (enname == "szwg2")    {subgamern = "szwg";}
                else if (enname == "brnn2")    {subgamern = "brnn";}
                else if (enname == "ddz2")     {subgamern = "ddz";}
                else if (enname == "bcbm2")    {subgamern = "bcbm";}
                else if (enname == "hh2")      {subgamern = "hh";}
                else if (enname == "dzpk2")    {subgamern = "dzpk";}
                else if (enname == "shaibao2") {subgamern = "shaibao";}
                else if (enname == "sss2")     {subgamern = "sss";}
                else if (enname == "ermj2")    {subgamern = "ermj";}
                else if (enname == "pdk2")     {subgamern = "pdk";}
                else if (enname == "21d2")     {subgamern = "21d";}
                else if (enname == "bjl2")     {subgamern = "bjl";}
                else if (enname == "lp2")      {subgamern = "lp";}
                else if (enname == "qznn2")    {subgamern = "qznn";}  
    ...
    refreshFuxinSubGameBtn(customEventData) {
        // console.log("刷新富鑫子游戏按钮", customEventData)
        this.suggameScrollView.scrollToLeft(0.5);
        let btnnum = 0;
        this.selectType = customEventData;
        if (customEventData == 'all') {
        ...
        if (customEventData == 'all') {
            ...
            for (let i = 0; i < this.subGameBtnArr.length; i++) {
                if(this.subGameBtnArr[i]){
                    let key = this.subGameBtnArr[i].tempdata.enname
                    if (this.subGameList[key].gameType == type) {
                        hqq.setSprite(this.subGameBtnMap[key].getChildByName("ani"), { normal: "hall/language/"+hqq.language+"/ninetwo/bigicon/icon"+key ,width: 276, height: 372})
        ...
        if (this && this.subGameBtnMap && this.subGameBtnMap["sgj"] && hqq.app.pinpai != "xinsheng") {
            if (this.subGameBtnMap["sgj"].getChildByName("goldlabel")) {
                ...
                if (/* hqq.app.pinpai == "xinsheng" || */ hqq.app.pinpai == "xingui" || hqq.app.pinpai == "xinlong") {
                    ...
                    hqq.setSprite(node0, { path: "hall/xinsheng/img/poolback" })
                    this.subGameBtnMap["sgj"].addChild(node0,this.subGameBtnMap["sgj"].getChildByName("ani").zIndex)
                } else if( hqq.app.pinpai == "huaxing"){
                    hqq.addNode(this.subGameBtnMap["sgj"].getChildByName("ani"),{path: "hall/huaxing/img/jjck",x:0,y:70,zIndex:-1});
                    ...
                    hqq.addNode(this.subGameBtnMap["sgj"].getChildByName("ani"),{path: "hall/ninetwo/img/jjck",x:3,y:70,zIndex:-1,width:170,type: cc.Sprite.Type.SLICED});
                    if( !tempbool ){
        ...
        if (this && this.subGameBtnMap && this.subGameBtnMap["hbsl"] && hqq.app.pinpai != "xinsheng" ) {
            if (this.subGameBtnMap["hbsl"].getChildByName("goldlabel")) {
                ...
                if (/* hqq.app.pinpai == "xinsheng" || */ hqq.app.pinpai == "xingui" || hqq.app.pinpai == "xinlong") {
                    ...
                    hqq.addNode(this.subGameBtnMap["hbsl"].getChildByName("ani"),{path: "hall/huaxing/img/jjck",x:0,y:70,zIndex:-1});
                    node.setPosition(0, 68)
                } else if( hqq.app.pinpai == "ninetwo"){
                    label.fontSize = 22
                    ...
                    hqq.addNode(this.subGameBtnMap["hbsl"].getChildByName("ani"),{path: "hall/ninetwo/img/jjck",x:3,y:70,zIndex:-1,width:170,type: cc.Sprite.Type.SLICED});
                    if( !tempbool ){
        ...
        if (this && this.subGameBtnMap && this.subGameBtnMap["hbld"] && hqq.app.pinpai != "xinsheng" ) {
            if (this.subGameBtnMap["hbld"].getChildByName("goldlabel")) {
                ...
                if (/* hqq.app.pinpai == "xinsheng" || */ hqq.app.pinpai == "xingui" || hqq.app.pinpai == "xinlong") {
                    ...
                    hqq.addNode(this.subGameBtnMap["hbld"].getChildByName("ani"),{path: "hall/huaxing/img/jjck",x:0,y:70,zIndex:-1});
                    node.setPosition(0, 68)
                } else if( hqq.app.pinpai == "ninetwo"){
                    label.fontSize = 22
                    ...
                    hqq.addNode(this.subGameBtnMap["hbld"].getChildByName("ani"),{path: "hall/ninetwo/img/jjck",x:3,y:70,zIndex:-1,width:170,type: cc.Sprite.Type.SLICED});
                    if( !tempbool ){
