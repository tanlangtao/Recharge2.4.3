...
cc.Class({
    ...
    UILoad() {
        ...
        if (hqq.app.pinpai != "xinsheng" ){
            hqq.btnLoad(registerbtn, "hall/language/" + hqq.language + "/img/registerbtn")
        }
        ...
        if (hqq.app.pinpai == "fuxin" ) {
            ...
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/fuxinregisterani", "animation", true)
        } else if (hqq.app.pinpai == "juding" ) {
            registerbtn.active = false
            hqq.setBtn(closebtn, { path: "hall/juding/btn_close", x: 360, y: 250 })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/fuxinregisterani", "animation", true)
            ...
            hqq.setSprite(aninode, {path:"hall/language/" + hqq.language + "/xinsheng/bigimg/d",width:1096,height:750,widget:{horizontalCenter:0,verticalCenter:0}})
            hqq.setSprite(registerbtn, { path: "hall/language/" + hqq.language + "/xinsheng/img/btn", position: { x: 0, y: -230 } })
            ...
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/xinsheng/img/givejinbi3", position: { x: 400, y: -205 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/huodong_signupbonus", "xunhuan", true)
            hqq.setBtn(closebtn, { path: "base/xinsheng/img/exit" })
            ...
            this.goldlabel.node.y = -174
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/xinsheng/img/givejinbi3", position: { x: 400, y: -205 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/huodong_signupbonus2", "xunhuan", true)
            hqq.setBtn(closebtn, { path: "base/xinsheng/img/exit" })
            ...
            this.goldlabel.node.y = -174
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/xinsheng/img/givejinbi", position: { x: 345, y: -194 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/xinshenghuodong", "xunhuan", true)
            hqq.setBtn(closebtn, { path: "base/xinsheng/img/exit" })
            ...
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/xinhao/givejinbi4", position: { x: 380, y: -185 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/huodong_signupbonus3", "xunhuan", true)
            hqq.setBtn(closebtn, { path: "base/xinsheng/img/exit" })
            ...
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/img/givejinbi", position: { x: 400, y: -210 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/huodong_signupbonus4", "xunhuan", true)
            ...
            hqq.setSprite(givejinbi, { path: "hall/language/" + hqq.language + "/img/givejinbi", position: { x: 380, y: -210 } })
            hqq.skeletonLoad(aninode, "hall/language/" + hqq.language + "/huodong", "xunhuan", true)
            hqq.setBtn(closebtn, { path: "base/img/p_close" })
        }
    },
    init(data) {
