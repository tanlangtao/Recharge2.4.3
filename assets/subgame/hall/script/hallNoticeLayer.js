cc.Class({
    ...
    UILoad() {
        ...
        if (hqq.app.pinpai == "fuxin" ) {
            ...
            hqq.setSprite(title_gonggao, { path: hlpath + "gonggaobiaoti" })
            hqq.setBtn(closebtn, { path: hpath + "fanhui", widget: { top: 0, left: 0 } })

            hqq.setBtn(notice, { path: hpath + "anniu1" })
            hqq.addNode(notice, { path: hlpath + "gg" })
            ...
            hqq.setSprite(this.item, { path: hpath + "di5", type: cc.Sprite.Type.SLICED })
        } else if (hqq.app.pinpai == "xingui") {
            let xpath = "hall/xingui/img/"
            let xlpath = "hall/language/" + hqq.language + "/xingui/"
            hqq.setSprite(back, { path: "hall/xingui/bg2", widget: { left: 0, right: 0, top: 0, bottom: 0 } })
            hqq.setSprite(title_gonggao, { path: xpath + "d_title", widget: { left: 30, top: 15 } })
            hqq.addNode(title_gonggao, { path: xlpath + "gonggao", y: -5 })

            hqq.setBtn(notice, { path: xpath + "btn_2" })
            hqq.addNode(notice, { string: "gg" })
            hqq.setBtn(email, { path: xpath + "btn_2" })
            ...
            let xbpath = "hall/xinsheng/bigimg/"
            let xpath = "hall/xinsheng/img/"
            let xlpath = "hall/language/" + hqq.language + "/xinsheng/img/"
            hqq.setSprite(back, { path: xbpath + "personback" })
            let hpath = "hall/test/img/"
            let hlpath = "hall/language/" + hqq.language + "/img/"
            hqq.setSprite(title_gonggao, { path: xlpath + "title_gonggao", widget: { left: 280, top: 15 } })
            let node = new cc.Node()
            hqq.setSprite(node, { path: xlpath + "gonggao" })
            notice.addChild(node)
            hqq.setBtn(notice, { path: xpath + "gongao1" })
            hqq.setBtn(email, { path: hlpath + "mail2", pressed: hlpath + "mail1" })
            hqq.setBtn(delet1, { path: hlpath + "delet1" })
            hqq.setBtn(closebtn, { path: xpath + "btnclose", widget: { left: 0, top: 0 } })
            ...
            hqq.setSprite(back, { path: hbpath+"jd_p_main_bg" })
            hqq.addNode(back, { path: hbpath + "jd_p_contain_bg", zIndex: -1, type: cc.Sprite.Type.SLICED })
            hqq.addNode(back, { path: hpath + "jd_p_menu_bg", zIndex: -1, type: cc.Sprite.Type.SLICED, widget:{left:0,top:70},width:300})
            hqq.setSprite(title_gonggao, { path: hlpath + "gonggaobiaoti" ,widget: { top: 15, left: 160 }})
            hqq.setBtn(closebtn, { path: hpath + "jd_p_btn_return", widget: { top: 0, left: 0 } })

            hqq.setBtn(notice, { normal: hpath + "jd_p_menu_btn_2" , pressed: hpath + "jd_p_menu_btn_1",transition:cc.Button.Transition.SPRITE})
            hqq.addNode(notice, { path: hlpath + "jd_menu_announce"})

            hqq.setBtn(email, { normal: hpath + "jd_p_menu_btn_2" , pressed: hpath + "jd_p_menu_btn_1",transition:cc.Button.Transition.SPRITE })
            hqq.addNode(email, { path: hlpath + "jd_menu_mailbox"})
            // hqq.setSprite(scrollback, { path: bpath + "di4", widget: { left: -(cc.winSize.width - 250), right: 18 }, active: true, type: cc.Sprite.Type.SLICED })
            email.active = true;
            let noticescroll = cc.find("noticelayer/scroll/noticescroll")
            ...
            hqq.setSprite(this.item, { path: hpath + "jd_item_bg", type: cc.Sprite.Type.SLICED , width:912,height:180})
            ...
            hqq.setSprite(back, { path: hbpath+"bg" })
            let d_ggtc = hqq.addNode(back, { path: hpath + "d_ggtc", zIndex: -1,width:1007*scalex,height:567*scaley, type: cc.Sprite.Type.SLICED })
            hqq.setWidget( d_ggtc , { right:40 , top:120 } )
            hqq.addNode(back, { path: hbpath + "d_top", zIndex: -2, widget: { top:0,left:0,right:0 } })
            hqq.setSprite(title_gonggao, { path: hlpath + "tit_gg" ,widget: { top: 15, horizontalCenter:1 },fontSize:28,lineHeight:30})
            hqq.setBtn(closebtn, { path: hpath + "btn_fh", widget: { top: 0, left: 0 } })

            hqq.setBtn(notice, { normal: hpath + "bq1"})
            ...
            hqq.addNode(back, { path: hpath+"d" , width:814,height:563,zIndex: -1});
            hqq.addNode(back, { path: hpath + "d1", zIndex: -2 })
            hqq.setSprite(title_gonggao, { path: hlpath + "title" ,widget: { top: 110, horizontalCenter:0 }})
            hqq.setBtn(closebtn, { path: hpath + "guanbi", widget: { closeleft:true,closeright:true,closetop:true,closebottom:true},x:400,y:280 })
            ...
            this.allread = hqq.addNode(back, { normal: hpath+"notice1" , x:-300,y:-230,callback:"onClickReadAllItem",script:this});
            hqq.addNode(this.allread,{string:"allread",y:-10,color:cc.color(72,47,7),fontSize:26,bold:true})
            this.alldelete = hqq.addNode(back, { normal: hpath+"notice1" , x:-140,y:-230,callback:"onClickAllDelete",script:this});
            hqq.addNode(this.alldelete,{string:"alldelete",y:-10,color:cc.color(72,47,7),fontSize:26,bold:true})
            
            hqq.setSprite(deletebtn,{path:hpath+"xiaoanniu",width:135,height:51});
            ...
            hqq.setSprite(back, { path: "hall/test/bigimg/p_main_bg" })
            hqq.setSprite(title_gonggao, { path: hlpath + "title_gonggao" })
            hqq.setBtn(notice, { path: hlpath + "gonggao2", pressed: hlpath + "gongao1" })
            hqq.setBtn(email, { path: hlpath + "mail2", pressed: hlpath + "mail1" })
            hqq.setSprite(titleimg, { path: hlpath + "subiconmail" })
            hqq.setBtn(delet1, { path: hlpath + "delet1" })
            hqq.setBtn(closebtn, { path: hpath + "p_new_saver_return" })
    ...
    initNoticeScroll() {
        ...
        cc.log("initNoticeScroll this.noticedata=",this.noticedata)
        for (let i = 0; i < this.noticedata.length; i++) {
            let mitem = cc.instantiate(this.item)
            if (hqq.app.pinpai == "fuxin" ) {
                hqq.setSprite(mitem, { path: "hall/fuxin/img/di5", type: cc.Sprite.Type.SLICED })
            } else if (hqq.app.pinpai == "xingui") {
                hqq.setSprite(mitem, { path: "hall/xingui/img/d_gg" })
            } else if (hqq.app.pinpai == "juding" ) {
                hqq.setSprite(mitem, { path: "hall/juding/img/jd_item_bg", type: cc.Sprite.Type.SLICED, width:912,height:180 })
            } else if (hqq.app.pinpai == "huaxing" ) {
                hqq.setSprite(mitem, { path: "hall/huaxing/img/d_gg0", type: cc.Sprite.Type.SLICED, width:964,height:165 })
            } else if (hqq.app.pinpai == "ninetwo" ) {
                hqq.setSprite(mitem, { path: "hall/ninetwo/img/d2", type: cc.Sprite.Type.SLICED, width:763,height:91 })
            }
            ...
            if(hqq.app.pinpai == "juding"){
                if(this.noticedata[i].isread){
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/juding/img/jd_letterOpen"})
                } else{
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/juding/img/jd_letteClose"})
                }
                ...
                if(this.noticedata[i].isread){
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/huaxing/img/youjian2"})
                } else{
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/huaxing/img/youjian1"})
                }
            } else if(hqq.app.pinpai == "ninetwo"){
                readstate.node.active = false;
                title.node.setPosition(-280,0);
                time.node.setPosition(135,20);
                ...
                mitem.height = 91;
                if(this.noticedata[i].isread){
                    hqq.setSprite(mitem, { path: "hall/ninetwo/img/d4", type: cc.Sprite.Type.SLICED, width:763,height:91 })
                } else{
                    hqq.setSprite(mitem, { path: "hall/ninetwo/img/d2", type: cc.Sprite.Type.SLICED, width:763,height:91 })
                }
        ...
        for (let i = 0; i < this.emaildata.length; i++) {
            ...
            if(hqq.app.pinpai == "juding"){
                if(this.emaildata[i].isread){
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/juding/img/jd_mailboxOpen"})
                } else{
                    hqq.setSprite(mitem.getChildByName("readstate"),{path:"hall/juding/img/jd_mailboxClose"})
                }
                mitem.getChildByName("readstate").x += 80;
                title.node.x += 200;
                title.node.color = cc.color(49,98,141);
    ...
    onClickReadItem(event, custom) {
        ...
        if( hqq.app.pinpai == "juding" ){
            if(this.noticedata[custom.key].isread){
                hqq.setSprite(this.noticeItemList[custom.key].getChildByName("readstate"),{path:"hall/juding/img/jd_letterOpen"})
            } else{
                hqq.setSprite(this.noticeItemList[custom.key].getChildByName("readstate"),{path:"hall/juding/img/jd_letteClose"})
            }
        } else if( hqq.app.pinpai == "ninetwo" ){
            if(this.noticedata[custom.key].isread){
                hqq.setSprite(this.noticeItemList[custom.key], { path: "hall/ninetwo/img/d4", type: cc.Sprite.Type.SLICED, width:763,height:91 })
            } else{
                hqq.setSprite(this.noticeItemList[custom.key], { path: "hall/ninetwo/img/d2", type: cc.Sprite.Type.SLICED, width:763,height:91 })
            }
            this.allread.getComponent(cc.Button).interactable = false;
            hqq.setSprite(this.allread,{path:"hall/ninetwo/img/notice2"})
            this.alldelete.getComponent(cc.Button).interactable = false;
            hqq.setSprite(this.alldelete,{path:"hall/ninetwo/img/notice2"})
        }
    ...
    onClickReadAllItem() {
        for (let i = 0; i < this.noticedata.length; i++) {
            ...
            if( hqq.app.pinpai == "ninetwo" ){
                hqq.setSprite(this.noticeItemList[i], { path: "hall/ninetwo/img/d4", type: cc.Sprite.Type.SLICED, width:763,height:91 })
            }
        }
    ...
    onClickReadEmailItem(event, custom) {
        ...
        if(this.emaildata[custom.key].isread){
            hqq.setSprite(this.emailItemList[custom.key].getChildByName("readstate"),{path:"hall/juding/img/jd_mailboxOpen"})
        } else{
            hqq.setSprite(this.emailItemList[custom.key].getChildByName("readstate"),{path:"hall/juding/img/jd_mailboxClose"})
        }
        this.sublayer.active = true
    ...
    onClickSubClose() {
        if(hqq.app.pinpai == "ninetwo" ){
            ...
            hqq.setSprite(this.allread,{path:"hall/ninetwo/img/notice1"})
            this.alldelete.getComponent(cc.Button).interactable = true;
            hqq.setSprite(this.alldelete,{path:"hall/ninetwo/img/notice1"})
        }
    ...
    initSubLayer(custom, isemail) {
        ...
        if (isemail){
            ...
            let hbpath = "hall/juding/bigimg/";
            let hlpath = "hall/language/" + hqq.language + "/juding/";
            hqq.setSprite( subback ,{path:hpath+"jd_p_bandalibg_1"})
            hqq.addNode(subback,{path: hpath + "jd_popup_inBg",zIndex: -1});
            ...
            hqq.setSprite(titleimg, { path: hlpath + "jd_title_mailbox", x:-320,y:217 })
            hqq.setSprite(subclosebtn, { path: hpath + "jd_popup_btn_close",x:360,y:215})
            subclosebtn.width = 119;
            subclosebtn.height = 70;
            cc.log(subclosebtn.width)
            cc.log(subclosebtn.height)
            let tnode = hqq.addNode(subback, { normal: hpath + "jd_p_btn_1_2", x: 300, y: -220, callback: "onClickEmailDelete", script: this, })
            ...
            if (hqq.app.pinpai == "xingui") {
                let xlpath = "hall/language/" + hqq.language + "/xingui/"
                let xpath = "hall/xingui/img/"
                hqq.setSprite(titleimg, { path: xlpath + "subgg", y: 205 })
                this.subscroll._view.height = 380
                let bpath = "base/xingui/img/"
                hqq.setSprite(subback, { path: bpath + "d_tc" })
                let newnode = hqq.addNode(subback, { normal: xpath + "btn_3", widget: { top: 30, left: 50 }, callback: "onClickDelete", script: this })
                ...
                hqq.addNode(subback, { path: bpath + "tck", zIndex: -1, anchorX: 1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                hqq.addNode(subback, { path: bpath + "tck", zIndex: -1, anchorX: 1, scaleX: -1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                hqq.setSprite(titleimg, { path: hlpath + "gonggaobiaoti", y: 285 })
                ...
                hqq.addNode(tnode, { path: hlpath + "scct" })
                let subScrollback = cc.find("txtscroll", subback)
                hqq.setNode(subScrollback, { y: 20 })
            } else if (hqq.app.pinpai == "xinsheng" || hqq.app.pinpai == "xinlong") {
                let xlpath = "hall/language/" + hqq.language + "/xinsheng/img/"
                hqq.setSprite(subback, { path: "base/xinsheng/img/back1" })
                hqq.setSprite(titleimg, { path: xlpath + "title_gonggao", position: { x: -290, y: 220 } })
                ...
                // hqq.addNode(subback, { path: bpath + "tck", zIndex: -1, anchorX: 1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                // hqq.addNode(subback, { path: bpath + "tck", zIndex: -1, anchorX: 1, scaleX: -1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                hqq.setSprite(titleimg, { path: hlpath + "gonggaobiaoti", x:-320,y:217 })
                hqq.setSprite(subclosebtn, { path: hpath + "jd_popup_btn_close",x:360,y:215})
                subclosebtn.width = 119;
                subclosebtn.height = 70;
                let tnode = hqq.addNode(subback, { normal: hpath + "jd_p_btn_1_2", x: 300, y: -220, callback: "onClickDelete", script: this, })
                ...
                let hbpath = "hall/huaxing/bigimg/";
                let hlpath = "hall/language/" + hqq.language + "/huaxing/";
                hqq.setSprite( subback ,{path:hpath+"d_ggtc",width:857,height:529})
                hqq.setSprite(titleimg, { path: hlpath + "tit_gg", x:0,y:240 })
                hqq.setSprite(subclosebtn, { path: hpath + "btn_x",x:425,y:250})
                hqq.addNode( subback , {path:hpath+"d_tit",y:240,zIndex:-1});
                deletebtn.x = -320;
                deletebtn.y = 220
                deletebtn.getComponent(cc.RichText).string = hqq.getTip("deletebtn")
                // let subScrollback = cc.find("txtscroll", subback)
                ...
                let hbpath = "hall/ninetwo/bigimg/";
                let hlpath = "hall/language/" + hqq.language + "/ninetwo/img/";
                hqq.setSprite( subback ,{path:hpath+"d3",width:784,height:382,widget:{horizontalCenter:0,verticalCenter:0}})
                // hqq.setSprite(titleimg, { path: hlpath + "tit_gg", x:0,y:240 })
                hqq.setSprite(subclosebtn, { path: hpath + "notice1",x:300,y:-230})
                ...
                if(!cc.isValid(this.sublayertitle)){
                    this.sublayertitle = hqq.addNode( cc.find("noticelayer/sublayer/back/txtscroll/view/content"),{string:"",x:-225,y:-40,anchorX:0,fontSize:26})
                }
