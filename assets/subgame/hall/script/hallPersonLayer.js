...
cc.Class({
    ...
    UILoad() {
        ...
        if (hqq.app.pinpai == "fuxin" ) {
            ...
            hqq.setSprite(title_personal, { path: hlpath + "biaoti", widget: { top: 13 } })
            hqq.addNode(background, { path: xpath + "di4", widget: { left: 300, right: 20, top: 100, bottom: 20 }, type: cc.Sprite.Type.SLICED })
            hqq.addNode(background, { path: hpath + "fgx", widget: { right: 400 } })
            // let personal = cc.find("personallayer/person")
            hqq.addNode(personal_form, { path: hlpath + "nc", x: -110, y: 190 })
            hqq.addNode(personal_form, { path: hlpath + "id", x: -100, y: 100 })
            hqq.addNode(personal_form, { path: hlpath + "sj", x: -110, y: 5 })
            hqq.addNode(personal_form, { path: hlpath + "ustd", x: -120, y: -90 })
            hqq.addNode(personal_form, { path: hlpath + "yhk", x: -125, y: -190 })
            ...
            hqq.setBtn(closebtn, { path: hpath + "fanhui", widget: { top: 0, left: 0 } })
            hqq.setBtn(changebt, { path: xpath + "anniu3", widget: { left: 31 } })
            hqq.addNode(changebt, { path: hlpath + "djqhtx" })
            hqq.setBtn(btn_copy, { path: hpath + "anniu5" })
            hqq.addNode(btn_copy, { path: hlpath + "fz" })
            hqq.setBtn(phone_btn_bind, { path: hpath + "anniu5" })
            hqq.addNode(phone_btn_bind, { path: hlpath + "bd" })
            hqq.setBtn(alipay_btn_bind, { path: hpath + "anniu5" })
            hqq.addNode(alipay_btn_bind, { path: hlpath + "bd" })
            hqq.setBtn(yinghangka_btn_bind, { path: hpath + "anniu5" })
            hqq.addNode(yinghangka_btn_bind, { path: hlpath + "bd" })

            hqq.setBtn(qiehuan, { path: xpath + "anniu4", x: -120 })
            hqq.addNode(qiehuan, { path: hlpath + "qhzh" })

            hqq.setSprite(txt_se, { path: hlpath + "yx" })
            hqq.setSprite(txt_bgm, { path: hlpath + "yy" })

            hqq.setSprite(headfram3, { path: hpath + "txk" })
            cc.resources.load(hlpath + "k", cc.SpriteFrame, (err, frame) => {
                if (err) {
            ...
            cc.resources.load(hlpath + "g", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            let xpath = "hall/xingui/img/"
            let xlpath = "hall/language/" + hqq.language + "/xingui/"
            hqq.setSprite(title_personal, { path: xpath + "d_title", widget: { top: 15, left: 30 } })
            hqq.addNode(title_personal, { path: xlpath + "gerxx", y: -5 })
            hqq.setSprite(background, { path: "hall/xingui/bg2", widget: { left: 0, right: 0, top: 0, bottom: 0 } })
            hqq.addNode(background, { path: xpath + "xian", widget: { right: 400 } })

            hqq.setBtn(closebtn, { path: xpath + "btn_fh", widget: { closeleft: true, right: 10, top: 10 } })
            hqq.setSprite(personal_form, { path: xlpath + "personform" })
            hqq.setWidget(headfram3, { left: 41, top: 100 })
            hqq.setBtn(changebt, { path: xpath + "btn_4", widget: { left: 31, top: 290 } })
            hqq.addNode(changebt, { string: "personch", fontSize: 30, y: -9 })
            hqq.setBtn(btn_copy, { path: xpath + "btn_3" })
            hqq.addNode(btn_copy, { string: "fz", fontSize: 25, y: -9 })
            hqq.setBtn(phone_btn_bind, { path: xpath + "btn_3" })
            hqq.addNode(phone_btn_bind, { string: "bd", fontSize: 25, y: -9 })
            hqq.setBtn(alipay_btn_bind, { path: xpath + "btn_3" })
            hqq.addNode(alipay_btn_bind, { string: "bd", fontSize: 25, y: -9 })
            hqq.setBtn(yinghangka_btn_bind, { path: xpath + "btn_3" })
            hqq.addNode(yinghangka_btn_bind, { string: "bd", fontSize: 25, y: -9 })
            hqq.setBtn(qiehuan, { path: "base/xingui/img/btn_1", x: -120 })
            hqq.addNode(qiehuan, { path: xlpath + "qiehzh" })

            hqq.setSprite(txt_se, { path: xlpath + "yx" })
            hqq.setSprite(txt_bgm, { path: xlpath + "yy" })

            cc.resources.load(xlpath + "k", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            cc.resources.load(xlpath + "g", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            let xlpath = "hall/language/" + hqq.language + "/xinsheng/img/"
            hqq.setWidget(headfram3, { left: 83 })
            hqq.setBtn(closebtn, { path: "hall/xinsheng/img/btnclose", widget: { left: 0, top: 0 } })
            hqq.setSprite(background, { path: "hall/xinsheng/bigimg/personback2", widget: { left: 0, right: 0, top: 0, bottom: 0 } })
            hqq.setSprite(title_personal, { path: xlpath + "grxx", widget: { top: 15, left: 330 } })
            hqq.setSprite(personal_form, { path: xlpath + "personform" }) // , position: { x: -149, y: 20 }
            hqq.setBtn(changebt, { path: xlpath + "changebt", widget: { left: 80 } })
            hqq.setBtn(btn_copy, { path: xlpath + "btn_copy" }) // , position: { x: 117, y: 120 }
            hqq.setBtn(phone_btn_bind, { path: xlpath + "btn_bind" }) // , position: { x: 117, y: 25 }
            hqq.setBtn(alipay_btn_bind, { path: xlpath + "btn_bind" })
            hqq.setBtn(yinghangka_btn_bind, { path: xlpath + "btn_bind" }) // , position: { x: 130, y: -170 }
            hqq.setBtn(qiehuan, { path: xpath + "btnback" })
            let node = new cc.Node();
            hqq.setSprite(node, { path: xlpath + "qhzh" })
            qiehuan.addChild(node)
            hqq.setSprite(txt_se, { path: xlpath + "txt_se" })
            hqq.setSprite(txt_bgm, { path: xlpath + "txt_bgm" })
            cc.resources.load(xlpath + "opensp", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            cc.resources.load(xlpath + "closesp", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            let hbpath = "hall/juding/bigimg/"
            let hlpath = "hall/language/" + hqq.language + "/juding/"
            hqq.setSprite(background, { path: hbpath + "jd_personal_bg" ,widget: { left: 0, right: 0, top: 0, bottom: 0 }})
            // hqq.addNode(background, { path: xpath + "bg", widget: { right: 0, left: cc.winSize.width / 2, }, anchorX: 1, scaleX: -1, type: cc.Sprite.Type.SLICED })
            hqq.setSprite(title_personal, { path: hlpath + "jd_title_personal", widget: { top: 11,left:162 } })
            ...
            hqq.setSprite(personal_form, { path: hlpath + "jd_personal_form"})

            hqq.setBtn(closebtn, { path: hpath + "jd_p_btn_return", widget: { top: 0, left: 0 } })
            hqq.setBtn(changebt, { path: hpath + "jd_p_btn_1_2", widget: { left: 90 } })
            hqq.addNode(changebt, { string:"personch" , fontSize:24,color:cc.color("#94510A"),y:-10,bold:true})
            hqq.setBtn(btn_copy, { path: hpath + "jd_p_btn_1_1" })
            hqq.addNode(btn_copy, { string:"fz" , fontSize:24,color:cc.color("#94510A"),y:-10,bold:true })
            hqq.setBtn(phone_btn_bind, { path: hpath + "jd_p_btn_1_1" })
            hqq.addNode(phone_btn_bind, { string: "bd" , fontSize:24,color:cc.color("#94510A"),y:-10,bold:true })
            hqq.setBtn(alipay_btn_bind, { path: hpath + "jd_p_btn_1_1" })
            hqq.addNode(alipay_btn_bind, { string: "bd" , fontSize:24,color:cc.color("#94510A"),y:-10,bold:true })
            hqq.setBtn(yinghangka_btn_bind, { path: hpath + "jd_p_btn_1_1" })
            hqq.addNode(yinghangka_btn_bind, { string: "bd" , fontSize:24,color:cc.color("#94510A"),y:-10,bold:true })

            hqq.setBtn(qiehuan, { path: hpath + "jd_p_btn_2", x: 120 })
            hqq.addNode(qiehuan, { string:"qiehuan" ,fontSize:24,color:cc.color("#FFFFFF"),y:-10,bold:true})

            hqq.setSprite(txt_se, { path: hlpath + "jd_personal_txt_se" ,x:375,y:-61})
            hqq.setSprite(txt_bgm, { path: hlpath + "jd_personal_txt_music",x:375,y:51 })

            hqq.setSprite(headfram3, { path: hpath + "jd_personal_headframe_1",widget: { left: 90 } })
            yinyuetoggle.node.setPosition(532,46);
            yinxiaotoggle.node.setPosition(532,-62);
            
            cc.resources.load(hlpath + "jd_personal_turnOn", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            cc.resources.load(hlpath + "jd_personal_turnOff", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            hqq.setSprite(background, { path: hbpath + "bg" ,widget: { left: 0, right: 0, top: 0, bottom: 0 }})
            let leftd_ggtc = hqq.addNode(background, { path: hpath + "d_ggtc", type: cc.Sprite.Type.SLICED,width:(763 * scalex)+((493 * scalex)-493 ),height:616 })
            hqq.setWidget(leftd_ggtc,{ left:17,top:114})
            let rightd_ggtc = hqq.addNode(background, { path: hpath + "d_ggtc", type: cc.Sprite.Type.SLICED,width:493,height:616 })
            hqq.setWidget(rightd_ggtc,{ top:114 ,right:32})
            hqq.addNode(background, { path: hbpath + "d_top", widget: { top:0,left:0,right:0 } })
            hqq.setSprite(title_personal, { path: hlpath + "grxx", widget: { top: 11,horizontalCenter:0 } })
            // cc.find("personallayer/person/personal_form/nick").color = cc.color("#546277");
            hqq.addNode(cc.find("personallayer/person/personal_form"),{path: hpath + "4",x:-10,y:180,width:230,height:40, type: cc.Sprite.Type.SLICED,zIndex: -1});
            ...
            // cc.find("personallayer/person/personal_form/id").color = cc.color("#546277");
            hqq.addNode(cc.find("personallayer/person/personal_form"),{path: hpath + "4",x:-10,y:90,width:230,height:40, type: cc.Sprite.Type.SLICED,zIndex: -1});
            ...
            // cc.find("personallayer/person/personal_form/phone").color = cc.color("#546277");
            hqq.addNode(cc.find("personallayer/person/personal_form"),{path: hpath + "4",x:-10,y:0,width:230,height:40, type: cc.Sprite.Type.SLICED,zIndex: -1});
            ...
            // cc.find("personallayer/person/personal_form/alipay").color = cc.color("#546277");
            hqq.addNode(cc.find("personallayer/person/personal_form"),{path: hpath + "4",x:5,y:-90,width:265,height:40, type: cc.Sprite.Type.SLICED,zIndex: -1});
            ...
            // cc.find("personallayer/person/personal_form/yinhangka").color = cc.color("#546277");
            hqq.addNode(cc.find("personallayer/person/personal_form"),{path: hpath + "4",x:5,y:-175,width:265,height:40, type: cc.Sprite.Type.SLICED,zIndex: -1});
            ...
            hqq.setBtn(closebtn, { path: hpath + "btn_fh", widget: { top: 0, left: 0 } })
            hqq.setBtn(changebt, { path: hlpath + "7", widget: { left: 90 } })
            hqq.setBtn(btn_copy, { path: hlpath + "12" ,x:30})
            hqq.setBtn(phone_btn_bind, { path: hlpath + "11" ,x:30})
            hqq.setBtn(alipay_btn_bind, { path: hlpath + "11" ,x:30})
            hqq.setBtn(yinghangka_btn_bind, { path: hlpath + "11" ,x:30,y:-175})

            hqq.setBtn(qiehuan, { path: hpath + "btn_2", x: -150 })
            hqq.addNode(qiehuan, { string:"qiehuan" ,fontSize:45,lineHeight:50,y:-5,bold:true})

            hqq.setSprite(txt_se, { path: hlpath + "2" ,x:303,y:-31})
            hqq.setSprite(txt_bgm, { path: hlpath + "1",x:303,y:81 })

            hqq.setSprite(headfram3, { path: hpath + "3",widget: { left: 80 } })
            yinyuetoggle.node.setPosition(460,76);
            yinxiaotoggle.node.setPosition(460,-32);

            hqq.addNode(yinyuetoggle.node.getChildByName("Background"),{path: hpath + "24" ,x:40})
            hqq.addNode(yinyuetoggle.node.getChildByName("checkmark"),{path: hpath + "24" ,x:-40})
            hqq.addNode(yinxiaotoggle.node.getChildByName("Background"),{path: hpath + "24" ,x:40})
            hqq.addNode(yinxiaotoggle.node.getChildByName("checkmark"),{path: hpath + "24" ,x:-40})
            
            cc.resources.load(hpath + "23", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            cc.resources.load(hpath + "22", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            hqq.setWidget(headfram3, { left: 83 })
            hqq.setBtn(closebtn, { path: "hall/test/img/p_new_saver_return" })
            hqq.setSprite(background, { path: "hall/test/bigimg/personal_di", widget: { left: 0, right: 0, top: 0, bottom: 0 } })
            hqq.setSprite(title_personal, { path: hlpath + "title_personal" })
            hqq.setSprite(personal_form, { path: hlpath + "personal_form" })

            hqq.setBtn(changebt, { path: hlpath + "changebt", widget: { left: 86 } })
            hqq.setBtn(btn_copy, { path: hlpath + "btn_copy" })
            hqq.setBtn(phone_btn_bind, { path: hlpath + "btn_bind" })
            hqq.setBtn(alipay_btn_bind, { path: hlpath + "btn_bind" })
            hqq.setBtn(yinghangka_btn_bind, { path: hlpath + "btn_bind" })
            hqq.setBtn(qiehuan, { path: hlpath + "qiehuan" })
            hqq.setSprite(txt_se, { path: hlpath + "txt_se" })
            hqq.setSprite(txt_bgm, { path: hlpath + "txt_bgm" })
            cc.resources.load(hlpath + "opensp", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
            ...
            cc.resources.load(hlpath + "closesp", cc.SpriteFrame, (err, frame) => {
                if (err) {
                    console.log("加载图片失败", err)
                    return;
                }
