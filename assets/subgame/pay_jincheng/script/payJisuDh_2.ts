...
export default class NewClass extends cc.Component {
    ...
    deleteAmount(){
        ...
        node.getComponent("payJisuCyjeAlert_2").init(this.amountLabel,this.channel,this.setDepostLabel.bind(this))
    ...
    showCashAlert(){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_2')
        ...
        node.getComponent('payCashAlert_2').init({
