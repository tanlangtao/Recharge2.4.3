cc.Class({
    ...
    UILoad() {
        ...
        hqq.setSprite(back, { Res:hqq["hall_chaofan"],path: "chaofan/bigimg/p_main_bg" })
        hqq.setSprite(title_gonggao, { Res:hqq["hall_chaofan"],path: hlbpath + "title_gonggao",widget:{horizontalCenter:false,left:0,right:0,top:0,bottom:0} })
        hqq.setBtn(notice, { Res:hqq["hall_chaofan"],path: hlpath + "gonggao2", pressed: hlpath + "gongao1" })
        hqq.setBtn(email, { Res:hqq["hall_chaofan"],path: hlpath + "mail2", pressed: hlpath + "mail1" })
        hqq.setSprite(titleimg, { Res:hqq["hall_chaofan"],path: hlpath + "subiconmail" })
        hqq.setBtn(delet1, { Res:hqq["hall_chaofan"],path: hlpath + "delet1" })
        hqq.setBtn(closebtn, { Res:hqq["hall_chaofan"],path: hpath + "p_new_saver_return",widget:{top:0,left:0} })
    ...
    initNoticeScroll() {
        ...
        for (let i = 0; i < this.noticedata.length; i++) {
            ...
            clickEventHandler.component = "hallNoticeLayer_chaofan";
