...
export default class NewClass extends cc.Component {
    ...
    onClick() {
        ...
        if(this.walletAddressInput.string == ''){
            ...
            if(this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35  && this.AqmLabel.string == "点击输入"){
    ...
    fetchBindAccountPay() {
        ...
        this.app.ajax('POST',url,dataStr,(response)=>{
            if(response.status == 0){
                let bankCom = cc.find('Canvas/Cash/Content/UsdtDh').getComponent('payUsdtDh_16');
                bankCom.fetchIndex();
    ...
    charCodeTrc20(s){
     ...
     setLanguageResource(){
        ...
        if(this.app.UrlData.package_id == 8||this.app.UrlData.package_id == 9){
            ...
            this.app.loadIconLg(`${src}/font/txt_qbdz`,popup_usdt_frame.children[0])
            this.app.loadIconLg(`${src}/font/txt_llx`,popup_usdt_frame.children[1])
        }else if(this.app.UrlData.package_id == 15 ||this.app.UrlData.package_id == 20|| this.app.UrlData.package_id == 18 || this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35 || this.app.UrlData.package_id == 12 || this.app.UrlData.package_id == 22){
