...
export default class NewClasss extends cc.Component {
    ...
    public init(data){
        ...
        this.parrentCom = data.parentComponent
        console.log(this.parrentCom.fetchIndex)
    }
    changeContent(data){
    ...
    onClick(){
            ...
            || this.account_nameInput.string == '')
        {
            ...
            this.node.getChildByName("bindAlipayAccount").active = false
