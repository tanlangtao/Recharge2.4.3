...
export default class NewClass extends cc.Component {
    ...
    setLanguageResource(){
        ...
        if(this.app.UrlData.package_id != 9 && this.app.UrlData.package_id != 15 && this.app.UrlData.package_id != 18 && this.app.UrlData.package_id != 16 && this.app.UrlData.package_id != 35 && this.app.UrlData.package_id != 20 && this.app.UrlData.package_id != 12 && this.app.UrlData.package_id != 22){
