...
export default class NewClass extends cc.Component {
            ...
            let callBack = (is_first)=>{
                ...
                if(this.first_min <=0) {
                    ...
                    arr.forEach((e)=>{
                        ...
                        node.getComponent("payBtnNum_16").init(e,this.addGold.bind(this))
                    ...
                    if(this.app.UrlData.package_id  == 16){
                        ...
                        arr.forEach((e)=>{
                            ...
                            node.getComponent("payCyjeItem_16").init(e,this.addGold.bind(this))
    ...
    public onClick(){
        ...
        if(this.amountLabel.string ==Language_pay.Lg.ChangeByText('点击输入')){
            ...
            else if(this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35  && this.current.name == this.handling_feeName && this.handling_fee !=0){
                //小额渠道提示
    ...
    showPayIM(){
        var url = `${this.app.UrlData.host}/api/payment/payment?user_id=${this.app.UrlData.user_id}&user_name=${decodeURI(this.app.UrlData.user_name)}&payment_amount=${this.amountLabel.string}&channel_type=${this.current.channel_id}&channel_name=${this.current.name}&pay_name=${this.current.nick_name}&pay_type=${this.current.pay_type}&client=${this.app.UrlData.client}&proxy_user_id=${this.app.UrlData.proxy_user_id}&proxy_name=${decodeURI(this.app.UrlData.proxy_name)}&package_id=${this.app.UrlData.package_id}&order_ip=${this.login_ip ? this.login_ip:"127.0.0.1"}&device_id=${this.app.gHandler.app.deviceID}&token=${this.app.token}&center_auth=${this.app.login_token}`;
        cc.find('payGlobal').getComponent('payGlobal_16').imWebViewUrl = encodeURI(url)
    ...
    showBindBankAccountTip(){
        ...
        node.getComponent("payBindBankAccountTipAlert_16").init(this)
        //检测是否已存在弹窗，避免重复显示
    ...
    setLanguageResource(){
        ...
        if(this.app.UrlData.package_id != 15 && this.app.UrlData.package_id != 20 && this.app.UrlData.package_id != 16 && this.app.UrlData.package_id != 35 && this.app.UrlData.package_id != 18 && this.app.UrlData.package_id != 12 && this.app.UrlData.package_id != 22){
        ...
        }else if(this.app.UrlData.package_id == 15 || this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35  || this.app.UrlData.package_id == 18||this.app.UrlData.package_id == 20 ||this.app.UrlData.package_id == 12 ||this.app.UrlData.package_id == 22){
        }else{
            this.app.loadIconLg(`${src}/btn/75`,btn_75)
    ...
    blinkFun(blinkNode){
        if(this.app.UrlData.package_id == 18 || this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35 ){
            //18不闪烁
