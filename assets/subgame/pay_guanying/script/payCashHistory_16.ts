...
export default class NewClass extends cc.Component {
        ...
        this.app.ajax('GET',url,'',(response)=>{
            ...
            if(response.status == 0){
                ...
                for(var i = 0; i < listArr.length; i++){
                    ...
                    node.getComponent('payCashHistoryListItem_16').init({
                        type : data.type,
                        amount : data.amount,
    ...
    pageLast(){
     ...
     setLanguageResource(){
        ...
        if(this.app.UrlData.package_id == 8 || this.app.UrlData.package_id==9 ||this.app.UrlData.package_id == 10 || this.app.UrlData.package_id == 15 || this.app.UrlData.package_id == 20 || this.app.UrlData.package_id == 18 || this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35 || this.app.UrlData.package_id == 12 || this.app.UrlData.package_id == 22) {
