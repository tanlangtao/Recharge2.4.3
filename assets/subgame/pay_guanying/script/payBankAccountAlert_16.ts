...
export default class NewClass extends cc.Component {
    ...
    onClick() {
        ...
        if(this.accountInput.string == '' || this.nameInput.string == ''){
            ...
            if(this.app.UrlData.package_id == 16 && this.AqmLabel.string == "点击输入"){
                ...
                return
            }else if(this.app.UrlData.package_id == 16 && this.AqmLabel.string.length < 4){
            ...
            //如果是充值打开隐藏按钮旁边的文字
            if(this.app.UrlData.package_id == 16 || this.app.UrlData.package_id == 35  && this.node.name == "Zfb"){
    ...
    fetchBindAccountPay() {
        ...
        if(this.app.UrlData.package_id == 35){
    ...
    addProvinceItem(){
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            node.getComponent('payBankSelectItem_16').init({
                text: results[i],
