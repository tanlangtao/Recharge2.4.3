...
export default class NewClass extends cc.Component {
    ...
    deleteAmount(){
        ...
        node.getComponent("payJisuCyjeAlert_26").init(this.amountLabel,this.channel,this.setDepostLabel.bind(this))
    ...
    showCashAlert(){
        ...
        let cash = cc.find('Canvas/Cash').getComponent('payCash_26')
        ...
        node.getComponent('payCashAlert_26').init({
