...
export default class NewClass extends cc.Component {
    ...
    public init(data){
        ...
        if(this.channel == 'alipay' ){
            this.app.loadPublicIcon('recharge/icon_alipay2',this.normalIcon,30,30)
            this.app.loadPublicIcon('recharge/icon_alipay1',this.currentIcon,30,30)
        }else if(this.channel == 'union_pay'){
            this.app.loadPublicIcon('recharge/icon_unionpay2',this.normalIcon,30,30)
            this.app.loadPublicIcon('recharge/icon_unionpay1',this.currentIcon,30,30)
        }else if(this.channel == 'wechat_pay'){
            this.app.loadPublicIcon('recharge/icon_wxpay2',this.normalIcon,30,30)
            this.app.loadPublicIcon('recharge/icon_wxpay1',this.currentIcon,30,30)
            ...
            this.app.loadPublicIcon('recharge/icon_im2',this.normalIcon,30,30)
            this.app.loadPublicIcon('recharge/icon_im1',this.currentIcon,30,30)
        }else if(this.channel =='digiccy'){
            this.app.loadPublicIcon('recharge/icon_usdt2',this.normalIcon,30,30)
            this.app.loadPublicIcon('recharge/icon_usdt1',this.currentIcon,30,30)
        }
    }
    onLoad () {
        this.app = cc.find('Canvas/Main').getComponent('payMain_20');
